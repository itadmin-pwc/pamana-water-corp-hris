...
$arrUser = $common->getUserHeaderInfo($sessionVars['empNo'],$_SESSION['employee_id']);
...
<html>
	...
	<LINK rel="SHORTCUT ICON" href="../images/logosi.png">
	<!--ext lib start -->
	...
	<body onLoad="startTime()" >
		<div id="header">
			<table border="0" cellpadding="0" cellspacing="1"  align="left" width="100%" height="100%" style="background-color: white;">
				<tr>
					<td width="175" rowspan="4">
						<?
							if($moduleName == 'PAYROLL'){
						?>
							<img src="../images/pg-payroll-logo.jpg" class="pgLogo">
						<?
							}
						?>
					</td>
				...
				<tr>
					<td width="110">
						<font  class="headerLabel">MODULE NAME</font>
					</td>	
					<td width="5">
						<font  class="headerLabel">:</font>
					</td>
					<td width="400">
						<font  class="headerLabelVal" id="moduleName">&nbsp;</font>
					</td>	
					<td width="100">
						<font  class="headerLabel">GROUP</font>
					</td>	
					<td >
						<font  class="headerLabel">:</font>
					</td>
					<td >
						<font  class="headerLabelVal" id="moduleName"><?=($sessionVars['payGrp'] == 1) ? "1 - ONE" : "2 - TWO";?></font>
					</td>				
				</tr>
				<tr>
					<td>
						<font class="headerLabel">USERNAME</font>
					</td>
					<td>
						<font class="headerLabel">:</font>
					</td>	
					<td>
						<font class="headerLabelVal"><?=$arrUser['empLastName'] . ", " . $arrUser['empFirstName'] . " " . substr($arrUser['empMidName'],0,1);?></font>
					</td>
					<td >
						<font  class="headerLabel">DATE</font>
					</td>	
					<td >
						<font  class="headerLabel">:</font>
					</td>
					<td >
						<font  class="headerLabelVal"><?=strtoupper(date("F d, Y"))?></font>
					</td>			
				</tr>
				<tr>
					<td>
						<font  class="headerLabel">COMPANY</font>
					</td>	
					<td>
						<font  class="headerLabel">:</font>
					</td>
					<td>
						<font  class="headerLabelVal" id="compName"><?=strtoupper($common->getCompanyName($sessionVars['compCode']))?></font>
					</td>	
					<td>
						<font class="headerLabel">TIME</font>
					</td>
					<td>
						<font class="headerLabel">:</font>
					</td>	
					<td>
						<font class="headerLabelVal" id="currTime"></font>
					</td>	
					<td width="165" align="center">
						<font class="logOutLabel"><a id="LogOut" href="#" class="logOut" onClick="Dolock(0)">LOCK</a><a href="#" class="logOut">|</a><a href="#" id="LogOut" class="logOut" onClick="DologOut()">LOG OUT</a></font>
					</td>						
				</tr>
			</table>
		</div>
