...
FROM         tblTK_CSApp where compCode='{$_SESSION['company_code']}' AND csStat='A' AND empNo IN ({$this->Emplist}) ";
	...
	function ClearAdjDtl() {
		...
		return $this->execQry($sqlClearAdjDtl);
	}
