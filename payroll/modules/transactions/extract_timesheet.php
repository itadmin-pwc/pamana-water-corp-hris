<?
session_start();
if (in_array($_SESSION['company_code'],array(4,5,15))) {
	header("Location: extract_timesheet_tna.php");	
}
			...
			<TABLE border="0" cellpadding="1" cellspacing="0" class="parentGrid">
				...
				<tr>
					<td class="parentGridDtl">
						<TABLE width="96%" border="0" align="center" cellpadding="0" cellspacing="2" class="childGrid" >
							<tr>
							...
							<tr>
								<td align="center" colspan="3" class="childGridFooter">
                                	<INPUT class="inputs" type="button" name="btnUpload" id="btnUpload" value="UPLOAD TS FROM PARADOX" onClick="procTimeSheet('U')">
									<INPUT class="inputs" type="button" name="btnProc" id="btnProc" value="PROCESS" onClick="procTimeSheet('P')">
									<INPUT class="inputs" type="button" id="btnCancel" value="CANCEL" onClick="parent.document.getElementById('contentFrame').src='';">
									<? if (in_array($_SESSION['company_code'],array(1,2,13,3))) {?>
							    <INPUT class="inputs" type="button" name="btnUpload2" id="btnUpload2" value="UPLOAD TS FROM TNA" onClick="TNA()"></td>
                                    <? } ?>
							</tr>
...
<SCRIPT>
	...
	function TNA() {
		location.href='extract_timesheet_tna.php';
	}
</SCRIPT>
