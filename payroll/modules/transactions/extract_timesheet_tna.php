...
$extractTNATSObj->validateSessions('','MODULES');



if($_GET['action'] == 'procTS'){
	
	if($extractTNATSObj->checkPeriodTimeSheetTag($_GET["pdYear"], $_GET["pdNum"]) > 0){
							...
							<tr>
								...
								<td class="gridDtlVal2">
									<font class="gridDtlLblTxt" id="compCode"><?
										$compName = $extractTNATSObj->getCompanyName($_SESSION['company_code']);
							...
							<tr>
								...
								<td class="gridDtlVal2">
									<font class="gridDtlLblTxt" id="payCat"><?
											...
											$paycatDesc = $extractTNATSObj->getPayCat($_SESSION['company_code'],$andPayCat);
							...
							<tr>
								...
								<td class="gridDtlVal2">
									<font class="gridDtlLblTxt" id="payPd"><?
											...
											$arrPayPeriod = $extractTNATSObj->getPayPeriod($_SESSION['company_code'],$andPayPeriod);
                                    	...
                                    	<?php
											$processTs = $extractTNATSObj->checkPeriodTimeSheetTag($arrPayPeriod['pdYear'],$arrPayPeriod['pdNumber']);
											if($processTs>0)
							...
							<tr>
								...
								<td class="gridDtlVal2">
										<font class="gridDtlLblTxt" id="DteCvrd"><?
											echo date("Y-m-d",strtotime($arrPayPeriod['pdFrmDate'])); 
											echo " - "; 
											echo date("Y-m-d",strtotime($arrPayPeriod['pdToDate'])); 
										?>
										</font>
								</td>
							</tr>
