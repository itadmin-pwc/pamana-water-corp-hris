...
/*
	...
	Function		:	TimeSheet Adjustment (Main Page) 
*/
...
<SCRIPT>
	pager("timesheet_adjustment_list_ajax.php",'empMastCont','load',0,0,'','','','../../../images/');  
	...
	function blackList_Pop(empNo,mode)
	{
		...
		resizable: false, 
		minimizable : true,
		title: " Time Sheet Adjustment", 
		showEffect:Effect.Appear, 
		destroyOnClose: true,
		maximizable: false,
		hideEffect: Effect.SwitchOff, 
		draggable:true })
		winPrevEmp.setURL('timesheet_adjustment_pop.php?&empNo='+empNo+'&mode='+mode);
