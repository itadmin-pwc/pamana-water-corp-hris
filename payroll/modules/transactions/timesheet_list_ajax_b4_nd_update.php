<?php
	...
	$qryEmpList = "SELECT TOP $intLimit *
			FROM tblEmpMast
			WHERE empNo NOT IN
			(SELECT TOP $intOffset empNo FROM tblEmpMast WHERE empPayGrp = '{$_SESSION['pay_group']}'
			 AND empPayCat = '{$_SESSION['pay_category']}'
			$empStat $empNo1 $empName1 $empDiv1 $empDept1 $empSect1 $empBrnCode1 $locType1"; 
	$qryEmpList .= " 
								...
								<td colspan="4" align="center">
										<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid2" >
											<tr>
												...
												<td width="10%" class="gridDtlLbl" align="left">ND</td>
												<td width="10%" class="gridDtlLbl" align="left">ND > 8</td>
											</tr>
											<?
											...
											<tr bgcolor2="<?php echo $bgcolor2; ?>">
												...
												<td width="10%" class="gridDtlVal" align="left"><font class="gridDtlLblTxt"><?=$TSVal['hrsNdGt8']. " / " . $TSVal['amtNdGt8']?></font></td>
											...
											<?
												...
												<tr bgcolor2="<?php echo $bgcolor2; ?>">
													...
													<td class="gridDtlVal" align="left"><font class="gridDtlLblTxt"><b><?=$arrTotal['totHrsNdGt8']. " / " . $arrTotal['totAmtNdGt8']?></b></font></td>
												</tr>
