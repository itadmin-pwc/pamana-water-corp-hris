...
################### INCLUDE FILE #################
	...
	$arrmtdGovtHist = $inqTSObj->Loans($_SESSION["company_code"], $_GET["pdYear"], $_GET["pdMonth"],2, $location);
	$arrmtdDeductHist = $inqTSObj->loanAdjustment($_GET["pdYear"], $_GET["pdMonth"], $location);
