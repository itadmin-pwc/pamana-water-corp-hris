		...
		if($cntmtdGovtHist>=1)
		{
			switch($remType) {
				case "S":
					...
					echo "window.open('"."sss_remittance_cover_page_pdf.php?&compCode=".$selCompCode."&pdYear=".$pdYear."&pdMonth=".$pdMonth."');";
				break;
				case "SL":
				...
				case "PAG":
					...
					echo "window.open('"."pag_remittance_pdf.php?&compCode=".$selCompCode."&pdYear=".$pdYear."&pdMonth=".$pdMonth."');";
				break;
				case "PAGL":
					//$genTxtFle = $inqTSObj->PagLoan_TxtFile($compCode, $pdYear, $pdMonth);
					//$path = 'HDMFLOAN.DBF';
					//$fName = 'PAGLOAN_'.$compCode."_".$pdMonth."_".$pdYear;
					echo "window.open('"."gov_loan_excel.php?&compCode=".$selCompCode."&pdYear=".$pdYear."&pdMonth=".$pdMonth."');";
					echo "window.open('"."pag_loan_pdf.php?&compCode=".$selCompCode."&pdYear=".$pdYear."&pdMonth=".$pdMonth."');";
				break;
				case "PH":
