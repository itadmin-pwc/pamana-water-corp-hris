	...
	<BODY>
        <form name="frmTS" method="post" action="<? echo $_SERVER['PHP_SELF']; ?>">
            <table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
           	 	<tr>
            		<td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Monthly Sss / Phic / Pag-Ibig Contribution</td>
            	</tr>
            			...
            			<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
            				<tr > 
            					<td class="gridToolbar" colspan="6"> 
            						...
            						<input name='fileName' type='hidden' id='fileName' value="monthly_contribution.php">            
                                </td>
            				</tr>
                            ...
                            <tr> 
                                ...
                                <?  
                                    $inqTSObj->DropDownMenu(array('S'=>'Sss','PAG'=>'Pag-Ibig','PH'=>'Philhealth'),'topType',$topType,$topType_dis); 
                                ?>
                                </td>
                            </tr>
