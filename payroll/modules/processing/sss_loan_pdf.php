...
################### INCLUDE FILE #################
	...
	$location  = ($_SESSION['company_code'] == 4) ? $_GET['location']:"";
		$arrSSSLoan = $pagRemObj->Loans($compCode, $pdYear, $pdMonth,1, $location);
		$arrSSSLoanAdj = $pagRemObj->loanAdjustment($pdYear,$pdMonth,$location, '5902');
