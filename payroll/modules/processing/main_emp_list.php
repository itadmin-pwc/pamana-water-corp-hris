...
<SCRIPT>
	...
	var repType=document.frmEmpList.repType.value;
	var reportType=document.frmEmpList.reportType.value;
	var topType = document.frmEmpList.topType.value;
	var orderBy=document.frmEmpList.orderBy.value;
	
	pager("main_emp_list_ajax.php","empMastCont",'load',0,0,'','','&fileName='+fileName+'&inputId='+inputId+'&empNo='+empNo+'&empName='+empName+'&empDiv='+empDiv+'&empDept='+empDept+'&empSect='+empSect+'&payPd='+payPd+"&repType="+repType+"&reportType="+reportType+"&topType="+topType+"&orderBy="+orderBy,'../../../images/');  
