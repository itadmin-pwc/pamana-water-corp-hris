...
switch ($inputId) {
	...
	case "mtdGovt":
		...
		echo "count: $selCompCode, $pdYear, $pdMonth\n";
		...
		if($cntmtdGovtHist>=1)
		{
			switch($remType) {
				case "S":
					$genTxtFle = $inqTSObj->Sss_TxtFile($compCode, $pdYear, $pdMonth, $location);
					$path = 'NR3001DK.txt';
					$fName = 'SSS_'.$compCode."_".$pdMonth."_".$pdYear;
					echo "window.open('"."sss_remittance_pdf.php?&compCode=".$selCompCode."&pdYear=".$pdYear."&pdMonth=".$pdMonth."&location=".$location."');";
					echo "window.open('"."sss_remittance_cover_page_pdf.php?&compCode=".$selCompCode."&pdYear=".$pdYear."&pdMonth=".$pdMonth."&location=".$location."');";
				break;
				case "SL":
					$genTxtFle = $inqTSObj->SSSLoan_TxtFile($compCode, $pdYear, $pdMonth, $location);
					$path = 'NR3002DK';
					$fName = 'SSSLOAN_TEMP_'.$compCode."_".$pdMonth."_".$pdYear;
					echo "window.open('"."sss_loan_pdf.php?&compCode=".$selCompCode."&pdYear=".$pdYear."&pdMonth=".$pdMonth."&location=".$location."');";
				break;
				case "PAG":
					echo "window.open('"."gov_remittance_excel.php?&compCode=".$selCompCode."&pdYear=".$pdYear."&pdMonth=".$pdMonth."&location=".$location."');";
					echo "window.open('"."pag_remittance_pdf.php?&compCode=".$selCompCode."&pdYear=".$pdYear."&pdMonth=".$pdMonth."&location=".$location."');";
				break;
				case "PAGL":
					//$genTxtFle = $inqTSObj->PagLoan_TxtFile($compCode, $pdYear, $pdMonth);
					//$path = 'HDMFLOAN.DBF';
					//$fName = 'PAGLOAN_'.$compCode."_".$pdMonth."_".$pdYear;
					echo "window.open('"."gov_loan_excel.php?&compCode=".$selCompCode."&pdYear=".$pdYear."&pdMonth=".$pdMonth."&location=".$location."');";
					echo "window.open('"."pag_loan_pdf.php?&compCode=".$selCompCode."&pdYear=".$pdYear."&pdMonth=".$pdMonth."&location=".$location."');";
				break;
				case "PH":
					echo "window.open('"."phic_remittance_pdf.php?&compCode=".$selCompCode."&pdYear=".$pdYear."&pdMonth=".$pdMonth."&location=".$location."');";
				break;
			...
			if($path!="")
			{
				...
				{
					$files = glob("governmentals_textfiles/$fName/*"); // get all file names
	...
	case "mtdExcel":
		...
		$pdMonth = $payPdNum;
		$remType = $_GET["remType"];
		$pdNumber1 = $arrPayPd1["pdNumber"];
		$pdNumber2 = $arrPayPd2["pdNumber"];
		...
		if($cntmtdGovtHist>=1)
		{
			echo "window.open('"."remittance_cont_sum_excel.php?&compCode=".$selCompCode."&pdYear=".$pdYear."&pdMonth=".$pdMonth."&pdNum1=".$pdNumber1."&pdNum2=".$pdNumber2."');";
		} else {
