	...
	<BODY>
		<form name="frmTS" method="post" action="">
		  ...
		  <input type="hidden" name="catType" id="catType" value="<? echo $_GET['catType']; ?>">
            ...
            <input type="hidden" name="prName" id="prName" value="<? echo $_GET['prName']; ?>">
		</form>
		<div id="TSCont"></div>
...
<SCRIPT>
	...
	var prName=document.frmTS.prName.value;
	
	pager("payregister_list_ajax.php","TSCont",'load',0,0,'','','&empNo='+empNo+'&empName='+empName+'&empDiv='+empDiv+'&empDept='+empDept+'&empSect='+empSect+'&groupType='+groupType+'&orderBy='+orderBy+'&catType='+catType+'&payPd='+payPd+"&repType="+repType+"&reportType="+reportType+"&topType="+topType+"&empBrnCode="+empBrnCode+"&locType="+locType+"&prName="+prName,'../../../images/');  
</SCRIPT>