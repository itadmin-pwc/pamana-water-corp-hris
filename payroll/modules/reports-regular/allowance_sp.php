	...
	<BODY>
        ...
        <input type="hidden" name="empBrnCode" id="empBrnCode" value="0">
            <table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
            	<tr>
            		<td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Allowance Report</td>
            	</tr>
                ...
                <tr>
                  		...
                  		<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
              				<tr > 
                				<td class="gridToolbar" colspan="6"> 
                                	<input name="hide_option" type="hidden" id="hide_option" value="<? echo $option_menu; ?>"> 
                                  	...
                                  	<input name='fileName' type='hidden' id='fileName' value="allowance_sp.php">
                				</td>
              				</tr>
                            ...
                            <tr> 
                                ...
                                <td class="gridDtlVal"> 
                                    <div id="reptype"> 
                                        <? 					
                                            $arrdeductType = $inqTSObj->makeArr($inqTSObj->allowType($compCode,'Y'),'trnCode','allowDesc','All');
                    ...
                    <TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
                      <tr>
                        <td>
                            <CENTER>
                                <input type="button" name="searchTS9" id="searchTS9" class="inputs" <? echo $searchTS9_dis; ?> value="Allowance" onClick="valSearchTS(this.id);">
                            </CENTER>
                        </td>
                      </tr>
                    </table> 
