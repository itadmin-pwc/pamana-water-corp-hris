    ...
    <BODY>
        <form name="frmTS" method="post" action="<? echo $_SERVER['PHP_SELF']; ?>">
            <table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
                <tr>
                	<td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Loans  Report</td>
              </tr>
                		...
                		<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
                			<tr > 
                				<td class="gridToolbar" colspan="6"> 
                                    ...
                                    <input name='fileName' type='hidden' id='fileName' value="loans_report.php">                				</td>
                			</tr>
	          ...
	          <br>
                		<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
                			<tr>
                				<td>
                                    <CENTER>
                                    	<input type="button" name="DedLoans" id="DedLoans" class="inputs" <? echo $searchTS4_dis; ?> value="Loans Report" onClick="LoansReport();">
                                    </CENTER>
                				</td>
                			</tr>
                		</table> 
