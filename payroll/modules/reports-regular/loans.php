    ...
    <BODY>
        <form name="frmTS" method="post" action="<? echo $_SERVER['PHP_SELF']; ?>">
            <table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
                <tr>
                	<td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Loans Deducted Report</td>
              </tr>
                		...
                		<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
                			<tr > 
                				<td class="gridToolbar" colspan="6"> 
                                    ...
                                    <input name='fileName' type='hidden' id='fileName' value="loans.php">                				</td>
                			</tr>
                            ...
                            <tr> 
                                ...
                                <td width="81%" class="gridDtlVal">
                                    <input class="inputs" name="empNo" id="empNo" value="<? echo $empNo; ?>" <? echo $empNo_dis; ?> type="text" size="12" maxlength="11" onKeyPress="return isNumberInputEmpNoOnly(this, event);">                                </td>
                            </tr>
							...
							$inqTSObj->DropDownMenu(
								$inqTSObj->makeArr($inqTSObj->getLoanTypeListArt($_SESSION['company_code'],'')
									,'lonTypeCd','lonTypeDesc','')
								,'lonType',$cmbBranch,$cmBranch_dis
							);
						?></td>
                            </tr>
                            <tr>
	          ...
	          <br>
                		<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
                			<tr>
                				<td>
                                    <CENTER>
                                    	<input type="button" name="DedLoans" id="DedLoans" class="inputs" <? echo $searchTS4_dis; ?> value="Loans Deducted " onClick="DeductedLoans();">
                                    </CENTER>
                				</td>
                			</tr>
                		</table> 
