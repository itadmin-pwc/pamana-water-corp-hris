...
<SCRIPT>
	...
	pager("ot_nd_list_ajax.php","TSCont",'load',0,0,'','','&empNo='+empNo+'&empName='+empName+'&empDiv='+empDiv+'&empDept='+empDept+'&empSect='+empSect+'&groupType='+groupType+'&orderBy='+orderBy+'&catType='+catType+'&payPd='+payPd+"&repType="+repType+"&empBrnCode="+empBrnCode+"&locType="+locType,'../../../images/');  
</SCRIPT>