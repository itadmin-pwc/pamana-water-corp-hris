...
<form name="frmTS" method="post" action="<? echo $_SERVER['PHP_SELF']; ?>">
  <table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
    <tr>
      ...
      <td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Pay Slip</td>
	</tr>
	<tr>
		<td class="parentGridDtl" >
          ...
          <tr > 
            <td class="gridToolbar" colspan="6"> <input name="hide_option" type="hidden" id="hide_option" value="<? echo $option_menu; ?>"> 
              ...
              <input name='fileName' type='hidden' id='fileName' value="payslip.php">            </td>
          </tr>
          <tr>
		  ...
		  <tr>
		    ...
		    <td class="gridDtlLbl">:</td>
		    <td class="gridDtlVal"><?  
					$inqTSObj->DropDownMenu(array('2'=>'Regular Pay Slip','1'=>'Pay Slip for Allowances'),'tblEarnType',$tbl,$cmBranch_dis); 			  
...
<br>
			  <TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
				  <tr>
					<td>
						<CENTER>
                <input type="button" name="Payslip" id="Payslip" class="inputs" <? echo $searchTS2_dis; ?> value="Pay Slip" onClick="PaySlip('payslip_list_pdf');">
              </CENTER>
					</td>
				  </tr>
			  </table> 
