...
<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
				  <tr>
					<td>
						<CENTER>
                <input type="button" name="DailyLoansReport" id="DailyLoansReport" <? echo $searchTS2_dis; ?> value="    PDF    " onClick="LoansPerTypePerStore('pdf');">
                <input type="button" name="DailyLoansReport" id="DailyLoansReport" <? echo $searchTS2_dis; ?> value="   Excel   " onClick="LoansPerTypePerStore('excel');">
              </CENTER>
					</td>
				  </tr>
		  </table> 
