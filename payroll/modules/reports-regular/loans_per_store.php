...
<form name="frmTS" method="post" action="<? echo $_SERVER['PHP_SELF']; ?>">
  <table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
    <tr>
      ...
      <td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Loans Per Type Per Store Report</td>
	</tr>
	<tr>
		<td class="parentGridDtl" >
          ...
          <tr> 
		   ...
		   <tr>
		     ...
		     <td class="gridDtlLbl">:</td>
		     <td class="gridDtlVal"><? 					
								$arrLoanType = $inqTSObj->makeArr($inqTSObj->getLoanTypeListArt($compCode,""),'lonTypeCd','lonTypeDesc','');
								$inqTSObj->DropDownMenu($arrLoanType,'lonType',$empSect,$empSect_dis);
							?></td>
		     </tr>
		   <tr>
		     ...
		     <td class="gridDtlLbl">:</td>
		     <td class="gridDtlVal"><? 					
								$arrBranch = $inqTSObj->makeArr($inqTSObj->getbranchwil(),'brnCode','brnDesc','');
								$inqTSObj->DropDownMenu($arrBranch,'branch',$empSect,$empSect_dis);
							?></td>
		     </tr>
		   <tr> 
...
<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
				  <tr>
					<td>
						<CENTER>
                <input type="button" name="DailyLoansReport" class="inputs" id="DailyLoansReport" <? echo $searchTS2_dis; ?> value="    PDF    " onClick="LoansPerTypePerStore('pdf');">
                <input type="button" name="DailyLoansReport" class="inputs" id="DailyLoansReport" <? echo $searchTS2_dis; ?> value="   Excel   " onClick="LoansPerTypePerStore('excel');">
              </CENTER>
					</td>
				  </tr>
		  </table> 
