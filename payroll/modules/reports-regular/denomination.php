	...
	<BODY>
        <form name="frmTS" method="post" action="<? echo $_SERVER['PHP_SELF']; ?>">
            <table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
                <tr>
                	<td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Denomination Listing </td>
                </tr>
            		...
            		<td class="parentGridDtl" >
            			<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
            				<tr > 
            					<td class="gridToolbar" colspan="6"> <input name="hide_option" type="hidden" id="hide_option" value="<? echo $option_menu; ?>"> 
                                    ...
                                    <input name='fileName' type='hidden' id='fileName' value="denomination.php">
            					</td>
            				</tr>
            				 <tr> 
            			...
            			<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
            				<tr>
            					<td>
                                    <CENTER>
                                    <input type="button" name="searchTS8" id="searchTS8" class="inputs" <? echo $searchTS8_dis; ?> value="Denomination" onClick="valSearchTS(this.id);">
                                    </CENTER>
                                </td>
            				</tr>
            			</table> 
                ...
                <tr > 
            		<td class="gridToolbarOnTopOnly" colspan="6">
            			<CENTER>
                            <BLINK> 
                                <input name="mssg" id="mssg" type="text" size="100" style="color:RED; background-color:#fff; height:18px; text-align: center;  border:0px solid;" value="<? echo $msg; ?>">
                            </BLINK> 
            			</CENTER>	
            		</td>
            	</tr>
