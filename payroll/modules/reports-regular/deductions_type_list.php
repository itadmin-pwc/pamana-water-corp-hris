...
<SCRIPT>
	...
	pager("deductions_type_list_ajax.php","TSCont",'load',0,0,'','','&empNo='+empNo+'&empName='+empName+'&empDiv='+empDiv+'&empDept='+empDept+'&empSect='+empSect+'&payPd='+payPd+"&repType="+repType+"&reportType="+reportType+"&topType="+topType+"&empBrnCode="+empBrnCode,'../../../images/');  
</SCRIPT>