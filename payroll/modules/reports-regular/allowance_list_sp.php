...
<SCRIPT>
	...
	pager("allowance_list_ajax_sp.php","TSCont",'load',0,0,'','','&empNo='+empNo+'&empName='+empName+'&empDiv='+empDiv+'&empDept='+empDept+'&empSect='+empSect+'&groupType='+groupType+'&orderBy='+orderBy+'&catType='+catType+'&payPd='+payPd+"&repType="+repType+"&reportType="+reportType+"&topType="+topType,'../../../images/');  
</SCRIPT>