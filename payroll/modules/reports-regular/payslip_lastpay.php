...
<form name="frmTS" method="post" action="<? echo $_SERVER['PHP_SELF']; ?>">
  <table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
    <tr>
      ...
      <td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Pay Slip for Last Pay</td>
	</tr>
	<tr>
		<td class="parentGridDtl" >
		  ...
		  <tr>
		    ...
		    <td class="gridDtlVal"><font class="byOrder">
              ...
              <input name="tblEarnType" type="hidden" id="tblEarnType">
</font></td>
		    </tr>
...
<br>
			  <TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
				  <tr>
					<td>
						<CENTER>
                <input type="button" name="Payslip" id="Payslip" <? echo $searchTS2_dis; ?> value="Pay Slip" onClick="PaySlip('payslip_lastpay_list_pdf');">
              </CENTER>
					</td>
				  </tr>
			  </table> 
