...
$reportPath = "payreg_by_dept_pdf.php?fromDate=".$fromDate."&toDate=".$toDate."&empDiv=".$empDiv."&empDept=".$empDept."&empBrnCode=".$empBrnCode;
			...
			<TABLE border="0" width="100%" cellpadding="1" cellspacing="0" class="parentGrid">
				<tr>
					<td colspan="4" class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">
                    		&nbsp;PRINT PAYROLL SUMMARY BY DEPARTMENT :: <?php echo "GROUP - ".$_SESSION["pay_group"];?>
					...
					<td class="parentGridDtl">
						<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
						  	<td colspan="27" class="gridToolbar" align="">
								<input name="back" type="button" id="back" value="Back" onClick="location.href='payreg_by_dept.php';">
              				</td>
