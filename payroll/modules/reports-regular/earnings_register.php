...
<HTML>
	...
	<BODY>
		...
		<form name="frmTS" method="post" action="<? echo $_SERVER['PHP_SELF']; ?>">
            ...
            <tr>
            	<td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Earnings Register</td>
            </tr>
            		...
            		<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
            			<tr > 
            				<td class="gridToolbar" colspan="6"> 
                                ...
                                <input name='fileName' type='hidden' id='fileName' value="earnings_register.php">
            				</td>
            			</tr>
                       ...
                       <tr> 
                        ...
                        <tr> 
                            ...
                            <?  
                                $inqTSObj->DropDownMenu(array('0'=>'Both','1'=>'Regular','2'=>'Allowance'),'reportType',$reportType,$reportType_dis); 
