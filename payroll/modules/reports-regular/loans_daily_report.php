...
<form name="frmTS" method="post" action="<? echo $_SERVER['PHP_SELF']; ?>">
  <table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
    <tr>
      ...
      <td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;New Loans Daily Report</td>
	</tr>
	<tr>
...
<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
				  <tr>
					<td>
						<CENTER>
                <input type="button" name="DailyLoansReport" class="inputs" id="DailyLoansReport" <? echo $searchTS2_dis; ?> value="Daily Loans Report" onClick="DailyLoans();">
              </CENTER>
					</td>
				  </tr>
		  </table> 
