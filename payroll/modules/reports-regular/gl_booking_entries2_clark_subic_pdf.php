			...
			$GTotCre = $GTotDeb = 0;
				...
				foreach ($arrGLpos as $val){
					if ($valbranch['glCodeStr'] == $val['strCode']) {
						...
						//$pdf->Cell(12,$SPACES,$val['compGLCode'],0,0);
						//$pdf->Cell(12,$SPACES,$val['majCode2'],0,0);
						//$pdf->Cell(12,$SPACES,$val['minCode2'],0,0);
						//$pdf->Cell(12,$SPACES,$val['strCode2'],0,0);
						$pdf->Cell(120,$SPACES,$val['glDesc'],0,0);
				...
				foreach ($arrGLneg as $val){
					if ($valbranch['glCodeStr'] == $val['strCode']) {
						...
						if ($pdf->GetY() > 255) HEADER_FOOTER($pdf, $inqTSObj, $compCode, $TOTAL_WIDTH, $dt);
							...
							$pdf->Cell(121,$SPACES,"GRAND TOTAL ",0,0,'C');
