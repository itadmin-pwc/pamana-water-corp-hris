	...
	<BODY>
        <form name="frmTS" method="post" action="<? echo $_SERVER['PHP_SELF']; ?>">
            <table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
            	<tr>
            		<td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Deductions Register</td>
            	</tr>
            		...
            		<td class="parentGridDtl" >
            			<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
            				<tr > 
            					<td class="gridToolbar" colspan="6"> 
                                	...
                                	<input name='fileName' type='hidden' id='fileName' value="deductions_register.php">
            					</td>
            				</tr>
                            ...
                            <tr> 
                                ...
                                <td class="gridDtlVal"> 
                                    <? 					
                                        $arrBranch = $inqTSObj->makeArr($inqTSObj->getBrnchArt($compCode),'brnCode','brnDesc','All');
                           ...
                           <tr> 
                            ...
                            <tr> 
                                ...
                                <td class="gridDtlVal"> 
                                    <font class="byOrder"> 
                                    <?
                                        $inqTSObj->DropDownMenu(array('1'=>'EMPLOYEE NAME','2'=>'EMPLOYEE NUMBER'),'orderBy',$orderBy,$orderBy_dis); 
                                    ?>
                                    </font> 
                                </td>
                            </tr>
            			...
            			<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
            				<tr>
            					<td>
                                    <CENTER>
                                    	<input type="button" name="searchTS3" id="searchTS3" class="inputs" <? echo $searchTS3_dis; ?> value="Deductions Register" onClick="valSearchTS(this.id);">
                                    </CENTER>
            					</td>
            				</tr>
            			</table> 
            	...
            	<tr > 
            		<td class="gridToolbarOnTopOnly" colspan="6">
            			<CENTER>
            				<BLINK> 
                            	<input name="dd" id="msddddg" type="text" size="100" style="color:RED; background-color:#fff; height:18px; text-align: center;  border:0px solid;" value="<? echo $msg; ?>">
                            </BLINK> 
            			</CENTER>	
            		</td>
            	</tr>
