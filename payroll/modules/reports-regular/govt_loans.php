    ...
    <BODY>
        <form name="frmTS" method="post" action="<? echo $_SERVER['PHP_SELF']; ?>">
            <table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
                <tr>
                	<td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Goverment Loans Remittance</td>
              </tr>
                		...
                		<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
                			<tr > 
                				<td class="gridToolbar" colspan="6"> 
                                    ...
                                    <input name='fileName' type='hidden' id='fileName' value="govt_loans.php">                				</td>
                			</tr>
			  ...
			  ?>
                            ...
                            <tr>
                              ...
                              <td class="gridDtlVal"><font class="byOrder">
                                <?
                                            $inqTSObj->DropDownMenu(array('1'=>'SSS','2'=>'Pag-Ibig'),'loanType',$loanType,$loanType_dis); 
                                        ?>
                              </font></td>
                          </tr>
                            <tr> 
...
function Loans() {
		...
		var thisValue = 'GovLoans';
		var loanType =document.frmTS.loanType.value;
		if (payPd=="" || payPd<0 || payPd=="0") {
			alert("Invalid Payroll Period.");
			return false;
		}
		branch = '&empBrnCode='+empBrnCode+'&locType='+locType+'&loanType='+loanType;
		new Ajax.Request(
