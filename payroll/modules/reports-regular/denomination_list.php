...
<SCRIPT>
	...
	pager("denomination_list_ajax.php","TSCont",'load',0,0,'','','&empNo='+empNo+'&empName='+empName+'&empDiv='+empDiv+'&empDept='+empDept+'&empSect='+empSect+'&orderBy='+orderBy+'&payPd='+payPd+'&reportType='+reportType+"&empBrnCode="+empBrnCode+"&locType="+locType,'../../../images/');  
</SCRIPT>