            	...
            	<td class="parentGridDtl" >
                       ...
                       <tr> 
                            ...
                            <td class="gridDtlVal"> 
                                <? 					
                                    ...
                                    $inqTSObj->DropDownMenu($arrBranch,'sel_BrnCode',$empBrnCode,$empBrnCode_dis);
                                ?>
                            </td>
                        </tr>
            		...
            		<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
            			<tr>
           				 	<td>
                				<CENTER>
            						<input type="button" name="searchTS6" id="searchTS6" <? echo $searchTS6_dis; ?> value="Deductions By Deduction Type" onClick="valSearchTS(this.id);">
            					</CENTER>
            				</td>
            			</tr>
            		</table> 
