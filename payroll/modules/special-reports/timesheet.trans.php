...
switch ($option_menu) {
	case "new_":
		...
		if ($empNo=="") {
			...
			$conType_dis = "class=\"inputs\" onKeyPress=\"getEmpSearch(event);\"";
			$monthto_dis = "class=\"inputs\" onKeyPress=\"getEmpSearch(event);\"";
			$monthfr_dis = "class=\"inputs\" onKeyPress=\"getEmpSearch(event);\"";
		} else {
	...
	case "refresh_":
		...
		$conType_dis = "class=\"inputs\" disabled=\"true\"";
		$monthto_dis = "class=\"inputs\" disabled=\"true\"";
		$monthfr_dis = "class=\"inputs\" disabled=\"true\"";
		$msg="";
		break;
