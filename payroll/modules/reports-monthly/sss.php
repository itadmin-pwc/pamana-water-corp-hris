          					...
          					<tr > 
            					<td class="gridToolbar" colspan="6"> 
                                	<input name="hide_option" type="hidden" id="hide_option" value="<? echo $option_menu; ?>"> 
              						...
              						<input name='fileName' type='hidden' id='fileName' value="sss.php">            
                                </td>
          					</tr>
						...
						<br>
			  			<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
                        	<tr>
                        		<td>
                        			<CENTER>
                        				<input type="button" name="searchTS2" class="inputs" id="searchTS2" <? echo $searchTS2_dis; ?> value="SSS Contributions" onClick="valSearchTS(this.id);">
                        			</CENTER>
                        		</td>
                        	</tr>
                        </table> 
