...
<br>
			  <TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
				  <tr>
					<td>
						<CENTER>
                <input type="button" name="yearly_ytd" id="yearly_ytd" <? echo $searchTS_dis; ?> value="  PDF  " onClick="YTDRepType('pdf');valSearchTS(this.id);">
                <input type="button" name="yearly_ytd" id="yearly_ytd" <? echo $searchTS_dis; ?> value="EXCEL" onClick="YTDRepType('excel');valSearchTS(this.id);">
					  </CENTER>
					</td>
				  </tr>
			  </table> 
