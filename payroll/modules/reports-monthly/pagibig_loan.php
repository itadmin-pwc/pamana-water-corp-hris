    ...
    <BODY>
        <form name="frmTS" method="post" action="<? echo $_SERVER['PHP_SELF']; ?>">
        	<table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
        		<tr>
        			<td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Pag - Ibig Monthly Loans Collection Report </td>
        		</tr>
                	...
                	<td class="parentGridDtl" >
                		<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
                			<tr > 
                					...
                					<input name='fileName' type='hidden' id='fileName' value="pagibig_loan.php">            
                                </td>
                			</tr>
        				...
        				<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
        					<tr>
        						<td>
                                    <CENTER>
                                    	<input type="button" name="searchTS6" id="searchTS6" class="inputs" <? echo $searchTS6_dis; ?> value="Pag-Ibig Loans" onClick="valSearchTS(this.id);">
                                    </CENTER>
        						</td>
        					</tr>
        				</table> 
