	...
	<BODY>
		<form name="frmTS" method="post" action="<? echo $_SERVER['PHP_SELF']; ?>">
            <table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
            	<tr>
            		<td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Payroll Summary Monthly Report</td>
            	</tr>
            	...
            	<tr>
            		<td class="parentGridDtl" >
            			<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
            				...
            				<tr> 
            					<td class="gridDtlLbl">From Payroll Period </td>
            					<td class="gridDtlLbl">:</td>
            					<td class="gridDtlVal"> 
                                	<div id="pdPay"> 
            							<input name="hide_payPd" type="hidden" id="hide_payPd" value="<? echo $payPd; ?>">
										<? 					
                                            $arrPayPd = $inqTSObj->makeArr($inqTSObj->getAllPayPeriods(),'pdPayable','pdPayable',''); // $module = 0 = 1st period, $modulo = 1 = 2nd period, $modulo = "" = both
                                            $inqTSObj->DropDownMenu($arrPayPd,'payPdfr',$payPd,$payPd_dis);
                                        ?>
            						</div>
                                </td>
            				</tr>
            				<tr>
            				  <td class="gridDtlLbl">To Payroll Period </td>
            				  <td class="gridDtlLbl">&nbsp;</td>
            				  <td class="gridDtlVal"><? 					
                                            $arrPayPd = $inqTSObj->makeArr($inqTSObj->getAllPayPeriods(),'pdPayable','pdPayable',''); // $module = 0 = 1st period, $modulo = 1 = 2nd period, $modulo = "" = both
                                            $inqTSObj->DropDownMenu($arrPayPd,'payPdto',$payPd,$payPd_dis);
                                        ?></td>
          				  </tr>
            				<!--
                            <tr> 
            			...
            			<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
            				<tr>
            					<td>
            						<CENTER>
            							<input type="button" class="inputs" name="searchTS" id="searchTS" <? echo $searchTS_dis; ?> value="Payroll Summary" onClick="paySum();">
            						</CENTER>
            					</td>
            				</tr>
            			</table> 
