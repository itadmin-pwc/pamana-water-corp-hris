	...
	<BODY>
		<form name="frmTS" method="post" action="<? echo $_SERVER['PHP_SELF']; ?>">
            <table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
            	<tr>
            		<td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Monthly Goverment Remittance</td>
            	</tr>
            		...
            		<td class="parentGridDtl" >
            			<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
                            ...
                            <tr>
                              ...
                              <td class="gridDtlLbl">:</td>
                              <td class="gridDtlVal"> <?  
                                    $inqTSObj->DropDownMenu(array('1'=>'Govt Loans & Contributions','2'=>'PFI Loans'),'cmbType','',"$payPd_dis onChange='MonthlyLoansType(this.value,$payPd)'"); 
                                ?></td>
                            </tr>
                            <tr> 
