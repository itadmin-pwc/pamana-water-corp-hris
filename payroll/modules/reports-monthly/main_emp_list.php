...
<SCRIPT>
	...
	pager("main_emp_list_ajax.php","empMastCont",'load',0,0,'','','&fileName='+fileName+'&inputId='+inputId+'&empNo='+empNo+'&empName='+empName+'&empDiv='+empDiv+'&empDept='+empDept+'&empSect='+empSect+"&topType="+topType+"&orderBy="+orderBy+"&payPd="+payPd,'../../../images/');  
