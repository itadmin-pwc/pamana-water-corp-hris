...
$reportPath = "philhealth_list_pdf.php?empNo=".$empNo."&empName=".$empName."&empDiv=".$empDiv."&empDept=".$empDept."&empSect=".$empSect."&orderBy=".$orderBy."&payPd=".$payPd."&topType=".$topType."&tbl=".$tbl."&table=".$table;
    ...
    <BODY>
		<div class="niftyCorner">
        	<TABLE border="0" width="100%" cellpadding="1" cellspacing="0" class="parentGrid">
        		<tr>
        			<td colspan="4" class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;PHILHEALTH MONTHLY CONTRIBUTION REPORT :: <?php echo "GROUP - ".$_SESSION["pay_group"];?> :: <?=strtoupper($catName['payCatDesc']);?> :: PAYROLL PERIOD (MONTHLY) = <?php echo strtoupper(date("F Y", strtotime($arrPayPd["pdPayable"]))); ?>
                	...
                	<td class="parentGridDtl">
                		<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
                			<td colspan="20" class="gridToolbar" align=""> 
                				<input name="back" type="button" id="back" value="Back" onClick="location.href='philhealth.php';">
                			</td>
                            ...
                            <tr>
                                <td colspan="20" align="center" class="childGridFooter">
                                    <? //$pager->_viewPagerButton("sss_list_ajax.php","TSCont",$intOffset,$_GET['isSearch'],'txtSrch','cmbSrch','&empNo='.$empNo."&empName=".$empName."&empDiv=".$empDiv."&empDept=".$empDept."&empSect=".$empSect."&groupType=".$groupType."&orderBy=".$orderBy."&catType=".$catType."&payPd=".$payPd."&table=".$table);?>
                                </td>
                            </tr>
       			 		</TABLE>
        			</td>
