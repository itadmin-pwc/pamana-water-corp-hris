...
<form name="frmTS" method="post" action="<? echo $_SERVER['PHP_SELF']; ?>">
  <table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
    <tr>
      ...
      <td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Philhealth Monthly Contributions 
        Report </td>
	</tr>
	<tr>
		<td class="parentGridDtl" >
          ...
          <tr > 
            <td class="gridToolbar" colspan="6"> <input name="hide_option" type="hidden" id="hide_option" value="<? echo $option_menu; ?>"> 
              ...
              <input name='fileName' type='hidden' id='fileName' value="philhealth.php">            </td>
          </tr>
          <tr> 
...
<br>
			  <TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
				  <tr>
					<td>
						<CENTER>
                <input type="button" name="searchTS3" class="inputs" id="searchTS3" <? echo $searchTS3_dis; ?> value="Philhealth Contributions" onClick="valSearchTS(this.id);">
              </CENTER>
					</td>
				  </tr>
			  </table> 
