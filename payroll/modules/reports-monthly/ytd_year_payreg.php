	...
	<BODY>
		<form name="frmTS" method="post" action="<? echo $_SERVER['PHP_SELF']; ?>">
  			<table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
    			<tr>
					<td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Yearly YTD by Pay Register</td>
				</tr>
...
<br>
			  <TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
				  <tr>
					<td>
						<CENTER>
                <input type="button" name="yearly_ytd_payreg" class="inputs" id="yearly_ytd_payreg" <? echo $searchTS_dis; ?> value="  PDF  " onClick="YTDRepType('pdf');valSearchTS(this.id);">
                <input type="button" name="yearly_ytd_payreg" class="inputs" id="yearly_ytd_payreg" <? echo $searchTS_dis; ?> value="EXCEL" onClick="YTDRepType('excel');valSearchTS(this.id);">
                        </CENTER>
					</td>
				  </tr>
			  </table> 
