...
150000866)
 group by empNo";
			...
			case "GETPASS":
				 $qryUsers = "SELECT    top 5 users.empNo, empMast.empLastName, empMast.empFirstName, userPass,  pages201, userLevel, category 
			...
			case "CHCKLEGPAYRD":
				$qryTs = "SELECT * FROM tblTimeSheet
							  WHERE compCode = '".$_SESSION["company_code"]."'
							  AND empNo = '010001392' 
							  AND tsDate >= '04/04/2011'
							  AND tsDate <= '04/16/2011' 
							  AND dayType in ('05')
							  AND empPayCat='".$_SESSION["pay_category"]."'
							  AND empPayGrp='".$_SESSION["pay_group"]."'";
				$resTs = $scriptsObj->execQry($qryTs);
				$arrTs = $scriptsObj->getArrRes($resTs);	
				
				foreach($arrTs as $arrTs_val)
				{
					$getPrevDay = mktime (0,0,0,date("m", strtotime($arrTs_val["tsDate"])),date("d", strtotime($arrTs_val["tsDate"]))-1,  date("Y", strtotime($arrTs_val["tsDate"])));
					
					$arrTsPrevDay = getPrevTsData($arrTs_val["empNo"], $getPrevDay);
							  
					if(($arrTsPrevDay["dayType"]=='01') && ($arrTsPrevDay["hrsAbsent"]!='8'))
					{
						echo "GENARRA";
					}
					elseif($arrTsPrevDay["dayType"]=='02')
					{
						if($arrTsPrevDay["hrsOtLe8"]>0)
							echo "GENARRA";
						else
							$arrTsPrevDay = getPrevTsData($arrTs_val["empNo"], $getPrevDay);
			...
			case "CHCKGLCODES":
				$sql_branch = "SELECT     brnDesc, brnShortName, compglCode, compglCodeHO, glCodeHO, glCodeStr
								FROM         tblBranch
								WHERE     (brnStat = 'A')
								ORDER BY compglCode, compglCodeHO, glCodeHO, brnDesc";
				$res_branch = $scriptsObj->execQry($sql_branch);
				$arr_branch = $scriptsObj->getArrRes($res_branch);	
				
				echo "<table border='1' width='100%'>";
					
					echo "<tr>";
						echo "<td>Branch Desc.</td>";
						echo "<td>Company GL Code</td>";
						echo "<td>Company GL HO Code</td>";
						echo "<td> GL Code HO</td>";
						echo "<td> GL Code STORE</td>";
						
					echo "</tr>";
					
					echo "<tr height='35px'>";
						echo "<td colspan = '5'><b>SALARIES AND WAGES</b></td>";
					echo "</tr>";
					/*foreach($arr_branch  as $arr_branch_val)
					{
						echo "<tr>";
							echo "<td>".$arr_branch_val["brnDesc"]."</td>";
							echo "<td>".$arr_branch_val["compglCode"]."</td>";
							echo "<td>".$arr_branch_val["compglCodeHO"]."</td>";
							echo "<td>".$arr_branch_val["glCodeHO"]."</td>";
							echo "<td>".$arr_branch_val["glCodeStr"]."</td>";
						echo "</tr>";
						
						//Get List of Depts
						$sql_deptglCodes = "Select * from tblDepartment 
											WHERE     (deptGlCode IS NOT NULL)
											order by deptDesc";
						$res_deptglCodes = $scriptsObj->execQry($sql_deptglCodes);
						$arr_deptglCodes = $scriptsObj->getArrRes($res_deptglCodes);
						
						
						foreach($arr_deptglCodes as $arr_deptglCodes_val)
						{
							echo "<tr>";
							...
							$sql_glCodes = "SELECT     *
											FROM         tblGLCodes
											WHERE     (strCode = '".$arr_branch_val["glCodeStr"]."') AND (compGLCode = '".$arr_branch_val["compglCode"]."') 
											AND (majCode = '710') and minCode='".$arr_deptglCodes_val["deptGlCode"]."'";
							$res_glCodes = $scriptsObj->execQry($sql_glCodes);
							$arr_glCodes  = $scriptsObj->getSqlAssoc($res_glCodes);		
							if($arr_glCodes ["glCodeDesc"]=="")
							{
								echo "<td></td>";
								echo "<td>".$arr_deptglCodes_val["deptGlCode"]."</td>";
								echo "<td>".$arr_deptglCodes_val["deptDesc"]."</td>";
								echo "<td>".$arr_glCodes ["glCodeDesc"]."</td>";
								
								$qry_insStatement = "Insert into tblGlCodes(compGlCode, majCode, minCode, strCode, glCodeDesc)
													values('".$arr_branch_val["compglCode"]."', '710', '".$arr_deptglCodes_val["deptGlCode"]."', '".$arr_branch_val["glCodeStr"]."', 'Salaries & Wages ".$arr_deptglCodes_val["deptGlCodeShortDesc"]." ".$arr_branch_val["brnShortName"]."')";
								echo "<td colspan='2'>".$qry_insStatement."</td>";
							}
							echo "</tr>";			
						}	
					...
					echo "<tr height='35px'>";
						echo "<td colspan = '5'><b>REIMBURSED EXPENSE</b></td>";
					echo "</tr>";
					/*foreach($arr_branch  as $arr_branch_val)
					{
						echo "<tr>";
						...
						foreach($arr_deptglCodes as $arr_deptglCodes_val)
						{
							...
							$sql_glCodes = "SELECT     *
											FROM         tblGLCodes
											WHERE     (strCode = '".$arr_branch_val["glCodeStr"]."') AND (compGLCode = '".$arr_branch_val["compglCode"]."') 
											AND (majCode = '711') and minCode='".$arr_deptglCodes_val["deptGlCode"]."'";
							$res_glCodes = $scriptsObj->execQry($sql_glCodes);
							$arr_glCodes  = $scriptsObj->getSqlAssoc($res_glCodes);		
							if($arr_glCodes ["glCodeDesc"]=="")
							{
								...
								$qry_insStatement = "Insert into tblGlCodes(compGlCode, majCode, minCode, strCode, glCodeDesc)
													values('".$arr_branch_val["compglCode"]."', '711', '".$arr_deptglCodes_val["deptGlCode"]."', '".$arr_branch_val["glCodeStr"]."', 'Reimbursed Expenses ".$arr_deptglCodes_val["deptGlCodeShortDesc"]." ".$arr_branch_val["brnShortName"]."')";
								echo "<td colspan='2'>".$qry_insStatement."</td>";
							}
							echo "</tr>";			
						}	
					...
					echo "<tr height='35px'>";
						echo "<td colspan = '5'><b>EMPLOYEE ALLOWANCE</b></td>";
					echo "</tr>";
					/*foreach($arr_branch  as $arr_branch_val)
					{
						echo "<tr>";
						...
						foreach($arr_deptglCodes as $arr_deptglCodes_val)
						{
							...
							$sql_glCodes = "SELECT     *
											FROM         tblGLCodes
											WHERE     (strCode = '".$arr_branch_val["glCodeStr"]."') AND (compGLCode = '".$arr_branch_val["compglCode"]."') 
											AND (majCode = '730') and minCode='".$arr_deptglCodes_val["deptGlCode"]."'";
							$res_glCodes = $scriptsObj->execQry($sql_glCodes);
							$arr_glCodes  = $scriptsObj->getSqlAssoc($res_glCodes);		
							if($arr_glCodes ["glCodeDesc"]=="")
							{
								...
								$qry_insStatement = "Insert into tblGlCodes(compGlCode, majCode, minCode, strCode, glCodeDesc)
													values('".$arr_branch_val["compglCode"]."', '730', '".$arr_deptglCodes_val["deptGlCode"]."', '".$arr_branch_val["glCodeStr"]."', 'Employees Allowance ".$arr_deptglCodes_val["deptGlCodeShortDesc"]." ".$arr_branch_val["brnShortName"]."')";
								echo "<td colspan='2'>".$qry_insStatement."</td>";
							}
							echo "</tr>";			
						}	
					...
					echo "<tr height='35px'>";
						echo "<td colspan = '5'><b>EMPLOYEE BENEFITS</b></td>";
					echo "</tr>";
					/*foreach($arr_branch  as $arr_branch_val)
					{
						echo "<tr>";
						...
						foreach($arr_deptglCodes as $arr_deptglCodes_val)
						{
							...
							$sql_glCodes = "SELECT     *
											FROM         tblGLCodes
											WHERE     (strCode = '".$arr_branch_val["glCodeStr"]."') AND (compGLCode = '".$arr_branch_val["compglCode"]."') 
											AND (majCode = '735') and minCode='".$arr_deptglCodes_val["deptGlCode"]."'";
							$res_glCodes = $scriptsObj->execQry($sql_glCodes);
							$arr_glCodes  = $scriptsObj->getSqlAssoc($res_glCodes);		
							if($arr_glCodes ["glCodeDesc"]=="")
							{
								...
								$qry_insStatement = "Insert into tblGlCodes(compGlCode, majCode, minCode, strCode, glCodeDesc)
													values('".$arr_branch_val["compglCode"]."', '735', '".$arr_deptglCodes_val["deptGlCode"]."', '".$arr_branch_val["glCodeStr"]."', 'Employees Benefits ".$arr_deptglCodes_val["deptGlCodeShortDesc"]." ".$arr_branch_val["brnShortName"]."')";
								echo "<td colspan='2'>".$qry_insStatement."</td>";
							}
							echo "</tr>";			
						}	
					...
					echo "<tr height='35px'>";
						echo "<td colspan = '5'><b>DEDUCTIONS (STORE BASED)</b></td>";
					echo "</tr>";
					...
					/*foreach($arr_branch  as $arr_branch_val)
					{
						...
						//Get List of tblPayTransType
						$sql_payTransType = "SELECT     pType.trnGlCode, dedMinor.minCode
												FROM         tblPayTransType pType INNER JOIN
																	  tblDeductionsMinor dedMinor ON pType.trnCode = dedMinor.trnCode
												WHERE     (pType.trnGlCode IS NOT NULL) AND (pType.trnGlCode <> '710') AND (pType.trnCat = 'D') AND (pType.trnGlCode IN ('370', '030', '770', '990', '745'))
												GROUP BY pType.trnGlCode, dedMinor.minCode
												ORDER BY pType.trnGlCode";
						$res_payTransType = $scriptsObj->execQry($sql_payTransType);
						$arr_payTransType = $scriptsObj->getArrRes($res_payTransType);
						
						//AND (pType.trnGlCode IN ('370', '030', '770', '990', '745'))
						foreach($arr_payTransType as $arr_payTransType_val)
						{
							//Get GL Codes
							$sql_glCodes = "SELECT     *
											FROM         tblGLCodes
											WHERE     (strCode = '".$arr_branch_val["glCodeStr"]."') AND (compGLCode = '".$arr_branch_val["compglCode"]."') 
											AND (majCode = '".$arr_payTransType_val["trnGlCode"]."') and minCode='".$arr_payTransType_val["minCode"]."'";
							
							$res_glCodes = $scriptsObj->execQry($sql_glCodes);
							$arr_glCodes  = $scriptsObj->getSqlAssoc($res_glCodes);		
							if($arr_glCodes ["glCodeDesc"]=="")
							{
								if(($arr_payTransType_val["trnGlCode"]=='030') && ($arr_payTransType_val["minCode"]=='100'))
									$glCodeShirtDesc = "AR-Others";
								elseif(($arr_payTransType_val["trnGlCode"]=='370') && ($arr_payTransType_val["minCode"]=='002'))
									$glCodeShirtDesc = "AP-Others (Cash Bond)";
								elseif(($arr_payTransType_val["trnGlCode"]=='745') && ($arr_payTransType_val["minCode"]=='107'))
									$glCodeShirtDesc = "Supplies MIS";
								elseif(($arr_payTransType_val["trnGlCode"]=='770') && ($arr_payTransType_val["minCode"]=='104'))
									$glCodeShirtDesc = "Meralco SOP";	
								elseif(($arr_payTransType_val["trnGlCode"]=='990') && ($arr_payTransType_val["minCode"]=='009'))
									$glCodeShirtDesc = "Penalties";	
								else
									$glCodeShirtDesc = "NO APPROPRIATE GL";
										
								
								$qry_insStatement = "Insert into tblGlCodes(compGlCode, majCode, minCode, strCode, glCodeDesc)
													values('".$arr_branch_val["compglCode"]."', '".$arr_payTransType_val["trnGlCode"]."', '".$arr_payTransType_val["minCode"]."', '".$arr_branch_val["glCodeStr"]."', '".$glCodeShirtDesc." ".$arr_branch_val["brnShortName"]."')";
								
								
								echo "<tr>";
									echo "<td>".$qry_insStatement."</td>";	
								echo "</tr>";	
							}
