<?
	...
	*/
	...
	if($_GET["btnUserDef"]!="")
	{
		...
		if($usrAcc!="")
		{
			$insQryBranch = "Delete from tblUserBranch where compCode='".$_SESSION["company_code"]."' and empNo='".$_GET["empNo"]."';";
		
			foreach($usrAcc as $usrAcc_val)
			{
				$insQryBranch.= "Insert into tblUserBranch(compCode, empNo, brnCode) values('".$_SESSION["company_code"]."', '".$_GET["empNo"]."','".$usrAcc_val."');";
