...
{
	$pdf->Cell(60,$SPACES,"Previous Employer Name    :",0,0);
	$pdf->Cell(60,$SPACES,$prevList['prevEmplr'],0,1);
	$pdf->Cell(60,$SPACES,"Year                      :",0,0);
	$pdf->Cell(60,$SPACES,$prevList['yearCd'],0,1);
	$pdf->Cell(60,$SPACES,"Address 1                 :",0,0);
	$pdf->Cell(60,$SPACES,$prevList['empAddr1'],0,1);
	$pdf->Cell(60,$SPACES,"Address 2                 :",0,0);
	$pdf->Cell(60,$SPACES,$prevList['empAddr2'],0,1);
	$pdf->Cell(60,$SPACES,"Address 3                 :",0,0);
	$pdf->Cell(60,$SPACES,$prevList['empAddr3'],0,1);
	$pdf->Cell(60,$SPACES,"TIN                       :",0,0);
	$pdf->Cell(60,$SPACES,$prevList['emplrTin'],0,1);
	$pdf->Cell(60,$SPACES,"Previous Earnings         :",0,0);
	$pdf->Cell(60,$SPACES,$prevList['prevEarnings'],0,1);
	$pdf->Cell(60,$SPACES,"Previous Taxes            :",0,0);
	$pdf->Cell(60,$SPACES,$prevList['prevTaxes'],0,1);
...
function HEADER_FOOTER($pdf, $inqEmpObj, $compCode, $employee) {
	...
	$pdf->reppages 		= "";
	$pdf->repId    		= "Report ID: PREEMP001";
	$pdf->repTitle 		= "Previous Employer of ".$employee;
	$pdf->refNo    		= "";
	
	$pdf->dtlLabelUp    = " P R E V I O U S   E M P L O Y E R  I N F O R M A T I O N";
	$pdf->dtlLabelDown  = "";
