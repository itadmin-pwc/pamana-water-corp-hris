...
<SCRIPT>
	...
	pager("inq_emp_list_ajax.php","empMastCont",'load',0,0,'','','&empNo='+empNo+'&empName='+empName+'&empDiv='+empDiv+'&empDept='+empDept+'&empSect='+empSect+'&groupType='+groupType+'&orderBy='+orderBy+'&catType='+catType,'../../../images/');  
</SCRIPT>