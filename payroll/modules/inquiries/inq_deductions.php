...
<form name="frmTS" method="post" action="<? echo $_SERVER['PHP_SELF']; ?>">
  <table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
    <tr>
      ...
      <td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Current 
        Employee Deductions</td>
	</tr>
	<tr>
		<td class="parentGridDtl" >
		  ...
		  <tr> 
            ...
            <td class="gridDtlVal"> <div id="pdPay"> 
                ...
                <? 					
								$arrPayPd = $inqTSObj->makeArr($inqTSObj->getAllPeriod($compCode,$groupType,$catType),'pdYear','pdYear','');
	...
	<br>
			  <TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
				  <tr>
					<td>
						<CENTER>
                <input type="button" name="searchTS3" id="searchTS3" class="inputs" <? echo $searchTS3_dis; ?> value="Deductions" onClick="valSearchTS(this.id);">
              </CENTER>
					</td>
				  </tr>
			  </table> 
