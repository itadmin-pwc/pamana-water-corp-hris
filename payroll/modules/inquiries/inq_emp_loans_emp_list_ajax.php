...
if ($_SESSION['pay_category']!=9)
	$empStat = "AND empStat NOT IN('RS','IN','TR','AWOL','EOC')";
else
	$empStat = "AND empStat IN ('RS','AWOL','EOC','IN','TR')";


$qryIntMaxRec = "SELECT * FROM tblEmpMast 
			     WHERE compCode = '{$_SESSION['company_code']}'
			     $empStat  and empPayGrp='{$_SESSION['pay_group']}' and empPayCat='{$_SESSION['pay_category']}'
			...
			<td class="parentGridDtl" valign="top">
				...
				<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
					<td colspan="4" class="gridToolbar">
						...
						<INPUT class="inputs" type="button" name="btnSrch" id="btnSrch" value="SEARCH" onclick="pager('inq_emp_loans_emp_list_ajax.php','empMastCont','Search',0,1,'txtSrch','cmbSrch','<?='&fileName='.$_GET['fileName'].'&inputId='.$_GET['inputId']?>','../../../images/')">					</td>
                       </tr> 
						<tr>
					...
					<tr>
						<td colspan="4" align="center" class="childGridFooter">
							<? $pager->_viewPagerButton("inq_emp_loans_emp_list_ajax.php",'empMastCont',$intOffset,$_GET['isSearch'],'txtSrch','cmbSrch','&fileName='.$_GET['fileName'].'&inputId='.$_GET['inputId']);?>						</td>
					</tr>
				</TABLE>
