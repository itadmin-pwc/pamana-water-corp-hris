...
$qryEmpList = "Select TOP $intLimit * from view_loansDailReport $div and lonSeries Not IN (Select TOP $intOffset lonSeries from view_loansDailReport $div)  "; 
	...
	<BODY>
		...
		<div class="niftyCorner">
			<TABLE border="0" width="100%" cellpadding="1" cellspacing="0" class="parentGrid">
			  ...
			  <td colspan="4" class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png"> TERMINATED LOANS  REPORT (
			    <?=$dt;?>)</td>
			  </tr>
				<tr>
					<td class="parentGridDtl">
						<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
						  	      <td colspan="26" class="gridToolbar" align=""> &nbsp; <a href="terminated_loans_pdf.php?empDiv=<?=$_GET['empDiv']?>&empDept=<?=$_GET['empDept']?>&empSect=<?=$_GET['empSect']?>&from=<?=$_GET['from']?>&to=<?=$_GET['to']?>&loanType=<?=$_GET['loanType']?>" target="_blank" title="Print Terminated Loans Report"> 
							<img src="../../../images/printer.png" align="absbottom" class="actionImg" title="Print Daily Loans Report"> TERMINATED LOANS  REPORT</a>&nbsp; <FONT class="ToolBarseparator">|</font> &nbsp; 
							<input name="back" type="button" id="back" value="Back" onClick="location.href='terminated_loans_report.php';"> &nbsp; 
                <FONT class="ToolBarseparator">|</font> &nbsp;</td>
							<tr>
								...
								<td width="5%" class="gridDtlLbl" align="center">TOTAL PAYMENTS </td>
							  <td width="5%" class="gridDtlLbl" align="center">CUR. BAL.</td>
							    <td width="5%" class="gridDtlLbl" align="center">LAST PAYMENT</td>
					          <td width="5%" class="gridDtlLbl" align="center">DATE TERMINATED </td>
							</tr>
							<?
							...
							<tr bgcolor="<?php echo $bgcolor; ?>" <?php echo $on_mouse; ?>>
								...
								<td class="gridDtlVal" align="right"><div align="center"><font class="gridDtlLblTxt">
							    <?=date('m/d/Y',strtotime($empListVal['closeddate']))?>
							    </font></div></td>
							</tr>
							<?
								}
							...
							<?}?>
							<tr>
								<td colspan="26" align="center" class="childGridFooter">
