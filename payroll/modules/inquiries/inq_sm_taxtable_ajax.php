<?php
	...
	*/
	...
	$qryIntMaxRec = "SELECT * from tblSmTax
					 ";
	...
	$qryTax = "SELECT TOP $intLimit tblSmTax.*,teuDesc from tblSmTax inner join tblTeu on tblSmTax.teuCode=tblTeu.teuCode
				WHERE txSeqNo NOT IN (SELECT TOP $intOffset txSeqNo FROM tblSmTax)
				";
		...
		<table border="0" width="100%" cellpadding="1" cellspacing="0" class="parentGrid">
			...
			<tr>
				<td colspan="4" class="parentGridHdr"> 
					&nbsp;<img src="../../../images/grid.png">&nbsp;SM Tax Table
				</td>
			</tr>
			<tr>
					...
					<table border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
						<tr > 
							<td class="gridToolbar" colspan="7"> 
								&nbsp;
								<a href="#" onClick="printSMTaxTable();">
						...
						<tr>
							...
							<td width="31%" class="gridDtlLbl" align="center">TAX EXEMPTION</td>
						  <td width="23%" class="gridDtlLbl" align="center">TAX  UP LIMIT</td>
						  <td width="22%" class="gridDtlLbl" align="center">FIXED AMOUNT</td>
						  <td width="20%" class="gridDtlLbl" align="center">ADDITIONAL %</td>
					  </tr>
						<?
						...
						?>
							...
							<tr>
								<td colspan="7" align="right" class="childGridFooter">
									<?$pager->_viewPagerButton("inq_sm_taxtable_ajax.php","taxListCont",$intOffset,$_GET['isSearch'],'txtSrch','cmbSrch','');?>
								</td>
							</tr>
