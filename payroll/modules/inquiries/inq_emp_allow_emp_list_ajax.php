					...
					<td class="gridDtlVal" align="center"> <a href="#" onclick="location.href='<?=$fileName?>?hide_option=<?=$inputId?>&empNo=<?=$empListVal['empNo']?>'"><img class="actionImg" src="../../../images/application_get.png" title="Select Employee"></a> 
							...
							<tr>
								<td colspan="4" align="center" class="childGridFooter">
									<? $pager->_viewPagerButton("inq_emp_allow_emp_list_ajax.php","empMastCont",$intOffset,$_GET['isSearch'],'txtSrch','cmbSrch','&empNo='.$empNo."&fileName=".$fileName."&inputId=".$inputId."&empName=".$empName."&empDiv=".$empDiv."&empDept=".$empDept."&empSect=".$empSect);?>
								</td>
							</tr>
						</TABLE>
					</td>
