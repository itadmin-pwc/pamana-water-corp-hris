...
$qryBrnList = "SELECT  brnCode,brnDesc,compglCode,glCodeStr,glCodeHO,brnStat FROM tblBranch
		        WHERE compCode = '{$_SESSION['company_code']}'";
        if($_GET['isSearch'] == 1){
        	if($_GET['srchType'] == 1){
			...
			<td class="parentGridDtl" valign="top">
				...
				<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
					...
					<tr>
						...
						<td width="20%" class="gridDtlLbl" align="center">GL CODE STORE / DESCRIPTION</td>
					...
					<tr bgcolor="<?php echo $bgcolor; ?>" <?php echo $on_mouse; ?>>
						...
						<td class="gridDtlVal"><font class="gridDtlLblTxt"><?=$brnLsitVal['brnDesc']?></font></td>
						...
						<td class="gridDtlVal" align="center">
							<font class="gridDtlLblTxt">
								<a onclick="maintBranch('EDIT','<?=$brnLsitVal['brnCode']?>','branch_listAjaxRes.php','branchMasterCont',<?=$intOffset?>,<?=$_GET['isSearch']?>,'txtSrch','cmbSrch')"><img class="toolbarImg" src="../../../images/application_form_magnify.png" title="Edit">
							</font>
						</td>
					</tr>
					<?
