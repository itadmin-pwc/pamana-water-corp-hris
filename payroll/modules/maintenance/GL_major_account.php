...
<SCRIPT>
	pager("GL_Major_Account_List_AjaxRes.php",'GlAcctCont','load',0,0,'','','','../../../images/');  
	...
	function maintGLAcct(act,GlCode,URL,ele,offset,isSearch,txtSrch,cmbSrch){
		...
		draggable:true })
		editGLAcct.setURL('GL_major_account_maintenance.php?action='+act+"&glCode="+GlCode+"&tbl=tblGLMajorAcct");
