// JavaScript Document
	...
	function valUpdateLoan() {
		...
		var oldLoanRef_No=document.frmEmpLoan.oldLoanRef_No.value;
		...
		new Ajax.Request(
		  'main_emp_loans_ajax.php?inputId=updateLoan&empNo='+empNo+'&loanType='+loanType+'&loanRefNo='+loanRefNo+'&loanPrinc='+loanPrinc+'&loanInt='+loanInt+'&loanStart='+loanStart+'&loanEnd='+loanEnd+'&loanPeriod='+loanPeriod+'&loanTerms='+loanTerms+'&loanDedEx='+loanDedEx+'&loanDedIn='+loanDedIn+'&loanPay='+loanPay+'&loanPayNo='+loanPayNo+'&loanBal='+loanBal+'&loanLastPay='+loanLastPay+'&dtGranted='+dtGranted+'&oldLoanRef_No='+oldLoanRef_No,
		  {
			 asynchronous : true,     
			 onComplete   : function (req){
				eval(req.responseText);
