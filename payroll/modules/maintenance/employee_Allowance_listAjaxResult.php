			...
			<td class="parentGridDtl" >
				<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
					...
					<tr>
                        ...
                        <td  class="gridDtlLbl" align="center" width="10%">ALLOWANCE TAG</td>
...
<!--						<td class="gridDtlVal">
						...
						<td class="gridDtlVal" align="center">
							...
							<a href="#" onclick="maintAllow('Edit','<?=$empAllwListVal['empNo']?>','<?=$empAllwListVal['allowCode']?>','employee_Allowance_listAjaxResult.php','empAllowList','<?=$empAllwListVal['allowCode']?>',<?=$intOffset?>,'',<?=$_GET['isSearch']?>,'txtSrch','cmbSrch')"><img class="toolbarImg" src="../../../images/application_form_magnify.png" title="Edit"></a>
						</td>
					</tr>
					<?
						}
