...
<SCRIPT>
	pager('period_list_ajax.php','TSCont','load',0,0,'','','','../../../images/');  
</SCRIPT>
<script type="text/javascript"> 
function Activate(pdSeries) {
	var ans  =  confirm("Are you sure you want to Open this payroll period?");
	if (ans == false) {
		return false;	
	}
	params = 'period_act.php?code=Open&pdSeries='+pdSeries;
