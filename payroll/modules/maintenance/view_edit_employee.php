...
$hdnCompCode = "";
$hdnEmpNo  = "";
$transType = (isset($_GET['transType'])) ? $_GET['transType'] : "";	


if($transType == 'edit' OR $transType == 'view' || $_GET['action'] == 'EDIT'){
...
if($transType == 'view' || $transType == 'edit'){
	$empNo="";
	if(isset($_GET['empNo'])){
		$empNo = $_GET['empNo'];
	}
...
<!--										<tr>
										...
										<tr>
											<td width="10%" class="gridDtlLbl" align="left">Position</td>
											<td width="1%" class="gridDtlLbl" align="center">:</td>
											<td class="gridDtlVal">
												
													<INPUT class="inputs" type="text" name="txtPosition" id="txtPosition" value="<?=htmlspecialchars($position)?>" size="40">
									...
									<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
										...
										<tr>
											...
											<td class="gridDtlVal">
													...
													<?$maintEmpObj->DropDownMenu(array('','SG'=>'Single','ME'=>'Married','SP'=>'Separated','WI'=>'Widow(er)'),'cmbMaritalStat',$maritalStatus,'class="inputs"'); ?>
										...
										<tr>
											<td width="1%" class="infoLabel" align="center" colspan="3">SALARY RELATED INFORMATION</td>
										</tr>
										<tr>
