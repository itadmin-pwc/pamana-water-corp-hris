...
$qryIntMaxRec = "SELECT * FROM tblGLMajorAcct 
...
$qryGLList = "SELECT TOP $intLimit *
		...
		WHERE compCode = '{$_SESSION['company_code']}'
		AND acctCde NOT IN
        (SELECT TOP $intOffset acctCde FROM tblGLMajorAcct WHERE compCode = '{$_SESSION['company_code']}'  "; 
...
<div class="niftyCorner">
	<TABLE border="0" width="100%" cellpadding="1" cellspacing="0" class="parentGrid">
		<tr>
			...
			&nbsp;<img src="../../../images/grid.png">&nbsp;GL MAJOR ACCOUNT</td>
	  </tr>
		<tr>
			<td class="parentGridDtl" valign="top">
				...
				<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
					<td colspan="8" class="gridToolbar">
                        ...
                        <a href="#"  class="anchor" onclick="maintGLAcct('ADD','','GL_Major_Account_List_AjaxRes.php','GlAcctCont',<?=$intOffset?>,<?=$_GET['isSearch']?>,'txtSrch','cmbSrch')">
                        <img class="anchor" src="../../../images/add.gif">Add GL Major Account</a> 
						...
						<INPUT class="inputs" type="button" name="btnSrch" id="btnSrch" value="SEARCH" onclick="pager('GL_Major_Account_List_AjaxRes.php','GlAcctCont','Search',0,1,'txtSrch','cmbSrch','','../../../images/')">
					</td>
					<tr>
					...
					<tr bgcolor="<?php echo $bgcolor; ?>" <?php echo $on_mouse; ?>>
						...
						<td class="gridDtlVal" align="center">
                            ...
                            <font class="gridDtlLblTxt">
                                <a onclick="maintGLAcct('EDIT','<?=$GLListVal['acctCde']?>','GL_Major_Account_List_AjaxRes.php','GlAcctCont',<?=$intOffset?>,<?=$_GET['isSearch']?>,'txtSrch','cmbSrch')"><img class="toolbarImg" src="../../../images/application_form_magnify.png" title="Edit">
                            </font>
					...
					<tr>
						<td colspan="8" align="center" class="childGridFooter">
							<? $pager->_viewPagerButton("GL_Major_Account_List_AjaxRes.php",'GlAcctCont',$intOffset,$_GET['isSearch'],'txtSrch','cmbSrch','');?>
						</td>
					</tr>
				</TABLE>
