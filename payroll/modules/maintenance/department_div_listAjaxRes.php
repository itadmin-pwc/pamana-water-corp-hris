...
$qryIntMaxRec = "SELECT * FROM tblDepartment 
        ...
        if($_GET['isSearch'] == 1){
        	if($_GET['srchType'] == 0){
        		$qryIntMaxRec .= "AND divCode = '{$_GET['txtSrch']}' ";
        	}
        	if($_GET['srchType'] == 1){
...
$qryDivList = "SELECT   * FROM tblDepartment
        ...
        if($_GET['isSearch'] == 1){
        	if($_GET['srchType'] == 0){
        		$qryDivList .= "AND divCode = '{$_GET['txtSrch']}' ";
        	}
        	if($_GET['srchType'] == 1){
			...
			<td class="parentGridDtl" valign="top">
				...
				<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
					...
					<tr bgcolor="<?php echo $bgcolor; ?>" <?php echo $on_mouse; ?>>
						...
						<td class="gridDtlVal" align="center">
							<font class="gridDtlLblTxt">
								<a onclick="maintDiv('EDIT','<?=$divListVal['divCode']?>','department_div_listAjaxRes.php','divMasterCont',<?=$intOffset?>,<?=$_GET['isSearch']?>,'txtSrch','cmbSrch')"><img class="toolbarImg" src="../../../images/application_form_magnify.png" title="Edit">
							</font>
						</td>
					</tr>
					<?
