		...
		<FORM name="frmBrnch" id="frmBrnch" action="<?=$_SERVER['PHP_SELF']?>" method="post">
				...
				<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
					...
					<tr>
						...
						<td width="1%" class="gridDtlLbl" align="center">:</td>
						<td class="gridDtlVal">
							<INPUT type="text" name="signatory" id="signatory" class="inputs" value="<?=htmlspecialchars($signatory)?>">						</td>
					</tr>
					<tr>
						<td class="gridDtlLbl" align="left" width="30%">
							Sign Title						</td>
						<td width="1%" class="gridDtlLbl" align="center">:</td>
						<td class="gridDtlVal">
							<INPUT type="text" name="sgnTitle" id="sgnTitle" class="inputs" value="<?=htmlspecialchars($sgnTitle)?>">						</td>
					</tr>
					<tr>
						<td class="gridDtlLbl" align="left" >
							Pay Group						</td>
					...
					<tr>
						...
						<td class="gridDtlVal">
							<?
								$brnchObj->DropDownMenu($brnchObj->makeArr(
										$brnchObj->getGLStoreList(),'acctCde','acctDesc',''
									),
