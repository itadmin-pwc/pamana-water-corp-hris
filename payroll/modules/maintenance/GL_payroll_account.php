...
<SCRIPT>
	pager("GL_Payroll_Account_List_AjaxRes.php",'GlAcctCont','load',0,0,'','','','../../../images/');  
	

	function maintGLAcct(act,GlCodeMajor,GlCodeMinor,GlCodeStore,URL,ele,offset,isSearch,txtSrch,cmbSrch){
		...
		draggable:true })
		editGLAcct.setURL('GL_payroll_account_maintenance.php?action='+act+"&glCodeMajor="+GlCodeMajor+"&glCodeMinor="+GlCodeMinor+"&glCodeStore="+GlCodeStore);
