...
if ($_SESSION['pay_category'] != 9) {
	$empStat = " AND empStat NOT IN('RS','IN','TR')";
}
...
$qryEmpList = "SELECT TOP $intLimit *
		...
		and
		empNo NOT IN
        (SELECT TOP $intOffset empNo FROM tblEmpMast WHERE  empPayGrp='".$_SESSION["pay_group"]."' $empStat and empPayCat='{$_SESSION['pay_category']}' and compCode = '{$sessionVars['compCode']}' and empPayCat<>0 $brnCodelist "; 
				...
				<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
					...
					<tr bgcolor="<?php echo $bgcolor; ?>" <?php echo $on_mouse; ?>>
						...
						<td class="gridDtlVal" align="center">
							<a href="#" onClick="location.href='profile.php?act=View&empNo=<?=$empListVal['empNo']?>&compCode=<?=$empListVal['compCode']?>'"><img class="toolbarImg" src="../../../images/application_form_magnify.png" title="View Employee Information"></a>
							<?php 
