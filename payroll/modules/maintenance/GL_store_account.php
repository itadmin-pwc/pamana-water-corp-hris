...
<SCRIPT>
	pager("GL_Store_Account_List_AjaxRes.php",'GlAcctCont','load',0,0,'','','','../../../images/');  
	...
	function maintGLAcct(act,GlCode,URL,ele,offset,isSearch,txtSrch,cmbSrch){
		...
		draggable:true })
		editGLAcct.setURL('GL_store_account_maintenance.php?action='+act+"&glCode="+GlCode+"&tbl=tblGLStoreAcct");
