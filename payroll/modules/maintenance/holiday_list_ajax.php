...
$qryHolList = "Select seqno,tblHolidayCalendar.compCode, tblHolidayCalendar.holidayDate, tblHolidayCalendar.brnCode, tblHolidayCalendar.holidayDesc, tblHolidayCalendar.dayType, tblHolidayCalendar.holidayStat, tblBranch.brnDesc , tblDayType.dayTypeDesc
FROM tblHolidayCalendar LEFT JOIN tblBranch ON tblHolidayCalendar.compCode = tblBranch.compCode AND tblHolidayCalendar.brnCode = tblBranch.brnCode LEFT JOIN tblDayType ON tblHolidayCalendar.dayType = tblDayType.dayType where tblHolidayCalendar.compCode = '{$_SESSION['company_code']}' ";		  
         if($_GET['isSearch'] == 1){
        	if($_GET['srchType'] == 0){
		...
		$qryHolList .= " order by tblBranch.brnDesc,holidayDate Limit $intOffset,$intLimit";
					...
					<td class="parentGridDtl">
						<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
						  	<tr>
                                ...
                                <a href="#" onClick="PopUp('holiday_act.php?act=AddHoliday','ADD HOLIDAY','<?=$dedListVal['recNo']?>','holiday_list_ajax.php','TSCont',<?=$intOffset?>,<?=$_GET['isSearch']?>,'txtSrch','cmbSrch')" class="anchor" ><img class="anchor" src="../../../images/add.gif">Add Holiday</a> |
						...
						<INPUT class="inputs" type="button" name="btnSrch" id="btnSrch" value="SEARCH" onClick="pager('holiday_list_ajax.php','TSCont','Search',0,1,'txtSrch','cmbSrch','','../../../images/')">                              
						  	...
						  	<tr>
								...
								<td width="10%" height="20" align="center" class="gridDtlLbl">TYPE</td>
								<td width="11%" class="gridDtlLbl" align="center">ACTION</td>
							</tr>
							<?
