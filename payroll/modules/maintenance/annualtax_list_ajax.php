<?php
	...
	*/
	...
	$qryTax = "SELECT * from tblAnnTax
				ORDER BY txLowLimit ASC Limit $intOffset,$intLimit";
		...
		<table border="0" width="100%" cellpadding="1" cellspacing="0" class="parentGrid">
			...
			<tr>
				<td colspan="4" class="parentGridHdr"> 
					&nbsp;<img src="../../../images/grid.png">&nbsp;ANNUAL TAX TABLE</td>
			</tr>
			<tr>
					...
					<table border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
						...
						?>
								<tr bgcolor="<?php echo $bgcolor; ?>" <?php echo $on_mouse; ?>>
								    ...
								    <?=$taxListVal['txLowLimit']?>
&nbsp;&nbsp;								    </font></div></td>
									<td class="gridDtlVal" ><div align="right"><font class="gridDtlLblTxt">
								    <?=$taxListVal['txUpLimit'] ?>
&nbsp;&nbsp;								    </font></div></td>
									<td class="gridDtlVal" ><div align="right"><font class="gridDtlLblTxt">
								    <?=$taxListVal['txFixdAmt']?>
&nbsp;&nbsp;								    </font></div></td>
									<td class="gridDtlVal" ><div align="right"><font class="gridDtlLblTxt">
								    <?=$taxListVal['txAddPcent'] ?>&nbsp;&nbsp;
								    </font></div></td>
								</tr>
							<?
								}
							...
							<tr>
								<td colspan="7" align="right" class="childGridFooter">
									<?$pager->_viewPagerButton("annualtax_list_ajax.php","TSCont",$intOffset,$_GET['isSearch'],'txtSrch','cmbSrch','');?>								</td>
							</tr>
						</table>
			  </td>
				</tr>
