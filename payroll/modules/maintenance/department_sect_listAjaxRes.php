...
$qryIntMaxRec = "SELECT * FROM tblDepartment 
        ...
        if($_GET['isSearch'] == 1){
        	if($_GET['srchType'] == 1){
        		$qryIntMaxRec .= "AND sectCode = '{$_GET['txtSrch']}' ";
        	}
        	if($_GET['srchType'] == 2){
        	...
        	if($_GET['srchType3'] == 1){
        		$qryIntMaxRec .= "AND deptCode = '{$arrDeptCode[1]}' ";
        	}
        }
...
$qryDivList = "SELECT   * FROM tblDepartment
        ...
        if($_GET['isSearch'] == 1){
        	if($_GET['srchType'] == 1){
        		$qryDivList .= "AND sectCode = '{$_GET['txtSrch']}' ";
        	}
        	if($_GET['srchType'] == 2){
        	...
        	if($_GET['srchType3'] == 1){
        		$qryDivList .= "AND deptCode = '{$arrDeptCode[1]}' ";
        	}
        }
			...
			<td class="parentGridDtl" valign="top">
				...
				<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
					...
					<tr bgcolor="<?php echo $bgcolor; ?>" <?php echo $on_mouse; ?>>
						...
						<td class="gridDtlVal" align="center">
							<font class="gridDtlLblTxt">
								<a onclick="maintSect('EDIT','<?=$divListVal['sectCode']?>','department_sect_listAjaxRes.php','sectMasterCont',<?=$intOffset?>,<?=$_GET['isSearch']?>,'txtSrch','cmbSrch')"><img class="toolbarImg" src="../../../images/application_form_magnify.png" title="Edit">
							</font>
						</td>
					</tr>
					<?
