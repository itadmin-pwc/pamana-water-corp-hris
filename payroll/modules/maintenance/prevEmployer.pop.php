	...
	*/
	...
	if($_GET["act"]=='Edit')
	{
		...
		if($mainContent6Obj->getRecCount($getPrevEmplrContent)>=1)
		{
			...
			$txtempbasic = $rowgetPrevEmplrContent["empBasic_Curr"];
			$txtempbasic_prev = $rowgetPrevEmplrContent["empBasic_Prev"];
			$optionEmpType = $rowgetPrevEmplrContent["empTypeTag"];
			if($optionEmpType=='T')
			{
				$readOnlyBasic= "";
				$readOnlyBasic_prev= "";
				$readOnly13thMonth="readonly";
				$readOnly13thNTaxMonth="readonly";
			}
			elseif($optionEmpType=='O')
			{
				$readOnlyBasic= "readonly";
				$readOnlyBasic_prev= "readonly";
				$readOnly13thMonth="";
				$readOnly13thNTaxMonth="";
			}
			else
			{
				$readOnlyBasic= "";
    	...
    	<form name="popContent6" id="popContent6" action="<?=$_SERVER['PHP_SELF']?>" method="post">
        	...
        	<?php
				echo "<table border='0' width='100%' cellpadding='1' cellspacing='1' class='childGrid'>\n";
					...
					echo "<tr>\n";
							echo "<td width='40%' class='gridDtlLbl' align='left'>Emp. Type</td>\n";
							echo "<td width='1%' class='gridDtlLbl' align='center'>:</td>";
							echo "<td  width='59%' class='gridDtlVal'><input type='radio' class='inputs' name='opt' id='opt' value='T' ".($optionEmpType=='T'?"checked":"")." onClick=disTextfile(1);>Transfer<input type='radio' class='inputs' name='opt' id='opt' value='O' ".($optionEmpType=='O'?"checked":"")." onClick=disTextfile(2);>Other Company <input type='radio' class='inputs' name='opt' id='opt' value='B' ".($optionEmpType=='B'?"checked":"")." onClick=disTextfile(3);>Both</td>\n";
					echo "</tr>\n";
					
					
					
					echo "<tr>\n";
							echo "<td width='40%' class='gridDtlLbl' align='left'>Emp. Basic (Current Year)</td>\n";
							echo "<td width='1%' class='gridDtlLbl' align='center'>:</td>";
							echo "<td  width='59%' class='gridDtlVal'><input type='text' class='inputs' name='txtempBasic' ".$readOnlyBasic." id='txtempBasic' value='".$txtempbasic."' ></td>\n";
					echo "</tr>\n";
					
					echo "<tr>\n";
							echo "<td width='40%' class='gridDtlLbl' align='left'>Emp. Basic (Previous Year)</td>\n";
							echo "<td width='1%' class='gridDtlLbl' align='center'>:</td>";
							echo "<td  width='59%' class='gridDtlVal'><input type='text' class='inputs' name='txtempBasic_prev' ".$readOnlyBasic_prev." id='txtempBasic_prev' value='".$txtempbasic_prev."' ></td>\n";
					echo "</tr>\n";
				
					echo "<tr>\n";
							echo "<td width='40%' class='gridDtlLbl' align='left'>13th Month Taxable</td>\n";
							echo "<td width='1%' class='gridDtlLbl' align='center'>:</td>";
							echo "<td  width='59%' class='gridDtlVal'><input type='text' class='inputs' name='txt13thTax' ".$readOnly13thMonth." id='txt13thTax' value=".$txt13thTax."></td>\n";
					echo "</tr>\n";
					
					echo "<tr>\n";
							echo "<td width='40%' class='gridDtlLbl' align='left'>13th Month Non - Taxable</td>\n";
							echo "<td width='1%' class='gridDtlLbl' align='center'>:</td>";
							echo "<td  width='59%' class='gridDtlVal'><input type='text' class='inputs' name='txt13thNonTax' ".$readOnly13thNTaxMonth." id='txt13thNonTax' value=".$txt13thNTax."></td>\n";
					echo "</tr>\n";
...
<script>
	function validation()
	{
		...
		if(frmpopContent6["opt"]=='T')
		{
			if(frmpopContent6["txtempBasic"]=="")
			{
				alert('Emp. Basic is required.');
				$('txtempBasic').focus();
				return false;
			}
			
			if(!frmpopContent6["txtempBasic"].match(numericExp))
			{
				alert('Invalid Emp. Basic: Numbers Only.');
				$('txtempBasic').focus();
				return false;
			}	
			
			if(frmpopContent6["txtempBasic_prev"]=="")
			{
				alert('Emp. Basic (Previous) is required.');
				$('txtempBasic_prev').focus();
				return false;
			}
			
			if(!frmpopContent6["txtempBasic_prev"].match(numericExp))
			{
				alert('Invalid Emp. Basic (Previous): Numbers Only.');
				$('txtempBasic_prev').focus();
				return false;
			}	
			
		}
		else if(frmpopContent6["opt"]=='O')
		{
	...
	function disTextfile($optype)
	{
		if($optype==1)
		{
			document.popContent6.txtempBasic.readOnly = false;
			document.popContent6.txtempBasic_prev.readOnly = false;
			document.popContent6.txt13thTax.readOnly = true;
			document.popContent6.txt13thNonTax.readOnly = true;
			document.popContent6.txt13thTax.value = 0;
			document.popContent6.txt13thNonTax.value = 0;
		}
		else if($optype==2)
		{
			document.popContent6.txtempBasic.readOnly = true;
			document.popContent6.txtempBasic_prev.readOnly = true;
			document.popContent6.txt13thTax.readOnly = false;
			document.popContent6.txt13thNonTax.readOnly = false;
			document.popContent6.txtempBasic.value = 0;
			document.popContent6.txtempBasic_prev.value = 0;
		}
		else
		{
			document.popContent6.txtempBasic.readOnly = false;
