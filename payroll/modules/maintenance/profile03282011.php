	...
	<BODY onLoad="focusTab(1); ">
		<FORM name='frmViewEditEmp' id="frmViewEditEmp" action="" onSubmit="return validateTabs('<?=$_GET['act']?>');" method="post" >
			<TABLE border="0" cellpadding="1" cellspacing="0" class="parentGrid" width="100%">
				<tr>
					<td class="parentGridHdr" height="30"> &nbsp;<img src="../../../images/grid.png">&nbsp; Personal Profile</td>
				</tr>
                        		...
                        		<tr> 
                        			<td align="left" class="parentGridDtl" height="300" valign="top">
                                            ...
                                            <tr>
                                            	...
                                            	<td class="headertxt">:</td>
                                            	<td class="gridDtlVal"><? $maintEmpObj->DropDownMenu($maintEmpObj->makeArr($maintEmpObj->getbankwil(),'bankCd','bankDesc',''),'cmbbank',$maintEmpObj->bank,'class="inputs" style="width:222px;" "disabled" onChange="checkno(\'empAcctNo\',\'\',\'' .$notype. '\',\'Account No.\',\'dvAcctNo\')"'); ?></td>
                                            </tr>
                        						...
                        						<td width="62%" valign="top">
                                                	<table width="99%" border="0" cellspacing="1" cellpadding="2">
                                                            ...
                                                            <td class="gridDtlVal">
                                                                <div id="dvposition">
                                                                    <?	
                                                                        ...
                                                                        $maintEmpObj->DropDownMenu($maintEmpObj->makeArr($maintEmpObj->getpositionwil($poswhere,1),'posCode','posDesc',''),'cmbposition',$maintEmpObj->position,'class="inputs" style="width:222px;" disabled onchange="getPosInfo(this.value);"');
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="gridDtlVal">
                                                                <div id='divdivision'><?=$Div['deptDesc']?></div>
                                                                <input class='inputs' maxlength="25" type="hidden" value="<?=$maintEmpObj->divCode?>"  name="txtDiv" id="txtDiv" />                                
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                        	...
                                                        	<td width="2%" class="headertxt">:</td>
                                                        	<td class="gridDtlVal">
                                                        		<div id='divdpt'><?=$Dept['deptDesc']?></div>
                                                        		<input class='inputs' maxlength="25" type="hidden" value="<?=$maintEmpObj->DepCode?>"  name="txtDept" id="txtDept" />                                
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                        	...
                                                        	<td width="2%" class="headertxt">:</td>
                                                        	<td class="gridDtlVal">
                                                            	<div id='divsection'><?=$Sect['deptDesc']?></div>
                                                        ...
                                                        <tr>
                                                        	...
                                                        	<td class="gridDtlVal">
                                                            	<div id="dvrank">
																	<?
                                                        				if ($maintEmpObj->empRank != '') 
                                                       						 echo 'Rank '.$maintEmpObj->empRank;
                                                        ...
                                                        <tr>
                                                        	...
                                                        	<td class="gridDtlVal">
                                                        		...
                                                        		<input class='inputs' maxlength="25" type="hidden" value="<?=$maintEmpObj->level?>"  name="txtLevel" id="txtLevel" />                                  
                                                            </td>
                                                        </tr> 
                                                        ...
                                                        <tr>
                                                        	...
                                                        	<td class="gridDtlVal">
                                                            	<div id="dvshift">
                                                        			<? $maintEmpObj->DropDownMenu($maintEmpObj->makeArr($maintEmpObj->getshiftwil($maintEmpObj->compCode),'shiftId','shiftDesc',''),'cmbshift',$maintEmpObj->Shift,'class="inputs" "disabled" style="width:222px;"'); ?>
                                                        		</div>
                                                             </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                        	...
                                                        	<td class="headertxt">:</td>
                                                        	<td class="gridDtlVal"><? $maintEmpObj->DropDownMenu(array("0"=>"",'RG'=>'Regular','PR'=>'Probationary','CN'=>'Contractual','RS'=>'Resigned','TR'=>'Terminated','IN'=>'Inactive','AP'=>'Applicant'),'cmbstatus',$maintEmpObj->Status,'class="inputs" "disabled" style="width:222px;"'); ?></td>
                                                        </tr>
                        			...
                        			<td align="left" class="parentGridDtl" height="300" valign="top">
                                    	<table width="90%" border="0" cellspacing="1" cellpadding="2">
                                            ...
                                            <tr>
                                            	...
                                            	<td class="headertxt">:</td>
                                            	<td class="gridDtlVal"><? $maintEmpObj->DropDownMenu(array('','D'=>'Daily','M'=>'Monthly'),'cmbpstatus',$maintEmpObj->PStatus,' class="inputs" "disabled" onChange="checkrate();" style="width:222px;"'); ?></td>
                                            </tr>
                        
                                            <tr>
                                            	<td width="26%" class="headertxt">Salary</td>
                                            	<td width="1%" class="headertxt">:</td>
                                            	<td class="gridDtlVal"><div id="dvsalary"><input class='inputs' disabled type="text" value="<?=$maintEmpObj->Salary?>"  name="txtsalary" onKeyUp="return computeRates(this.value,<?=$maintEmpObj->compCode?>,'1');" maxlength="9" id="txtsalary" readonly /></div></td>
                                            </tr>
                                            
                                            <tr>
                                            	<td width="26%" class="headertxt">Daily Rate</td>
                                            	<td width="1%" class="headertxt">:</td>
                                            	<td class="gridDtlVal"><div id="dvdailyrate"><input class='inputs' disabled type="text" value="<?=$maintEmpObj->Drate?>" onKeyUp="return computeRates(this.value,<?=$maintEmpObj->compCode?>,'0');"  name="txtdailyrate" maxlength="9" id="txtdailyrate" readonly /></DIV></td>
                                            </tr>
                        
                                            <tr>
                                            	<td width="26%" class="headertxt">Hourly Rate</td>
                                            	<td width="1%" class="headertxt">:</td>
                                            	<td class="gridDtlVal"><input class='inputs' type="text" disabled value="<?=$maintEmpObj->Hrate?>"  name="txthourlyrate" readonly maxlength="9" id="txthourlyrate" /></td>
                                            </tr>  
                                            ...
                                            <tr>
                                            	...
                                            	<td class="headertxt">:</td>
                                            	<td class="gridDtlVal"><div id="divpaycat"><? $maintEmpObj->DropDownMenu($maintEmpObj->makeArr($maintEmpObj->getPayCat($maintEmpObj->compCode,''),'payCat','payCatDesc',''),'cmbCategory',$maintEmpObj->paycat,'class="inputs" "disabled" style="width:222px;"'); ?></div></td>
                                            </tr>
                                            ...
                                            <tr>
                                            	...
                                            	<td class="headertxt">:</td>
                                            	<td class="gridDtlVal">
                                            		<? $maintEmpObj->DropDownMenu($maintEmpObj->makeArr($maintEmpObj->getTEU(),'teuCode','teuDesc',''),'cmbexemption',$maintEmpObj->Exemption,'class="inputs" "disabled" style="width:222px;"'); ?>
                                                </td>
                                            </tr>
                        				</table>
                                   	</td>
