<?php
	...
	$qryIntMaxRec = "SELECT * from tblAllowType where compCode='{$_SESSION['company_code']}'
					";
	...
	$qryAllow = "SELECT  *, CASE allowTypeStat WHEN 'A' THEN 'Active' WHEN 'H' THEN 'Held' END as status from tblAllowType where compCode='{$_SESSION['company_code']}'  Limit $intOffset,$intLimit
				";
			...
			<tr>
				<td class="parentGridDtl">
					<table border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
						...
						<tr>
						  <td colspan="6" align="center" class="gridToolbar"><?php if($_SESSION['user_level']==1){ ?> <div align="left"><span onClick="PopUp('allowtype_act.php?act=AddAllowanceType','ADD ALLOWANCE TYPE','<?=$dedListVal['recNo']?>','allowtype_list_ajax.php','TSCont',<?=$intOffset?>,<?=$_GET['isSearch']?>,'txtSrch','cmbSrch')" style="cursor:pointer;"><img class="anchor" src="../../../images/add.gif">Add Allowance Type</span></div><?php } ?></td>
					  </tr>
						<tr>
