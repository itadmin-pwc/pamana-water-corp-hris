...
$loanCode = 3; ///// 1=sss , 2=pagibig , 3=company
...
<table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
	<tr>
		<td class="parentGridHdr">
			&nbsp;<img src="../../../images/grid.png">&nbsp;Other Loans Set - Up
		</td>
	</tr>
	<tr>
		<td class="parentGridDtl" >
              ...
              <? echo $delete_loan; ?>&nbsp;&nbsp;<? echo $refresh_loan; ?> 
			  <input name='updateFlag' type='hidden' id='updateFlag'>
              <input name='fileName' type='hidden' id='fileName' value="main_emp_loans_company.php">	
			  <FONT class="ToolBarseparator">|</font> 
			  <a href="#" <? echo $printLoc; ?>> <img src="../../../images/<? echo $printImgFileName; ?>" align="absbottom" class="actionImg" title="Print Employee Loan"></a>            <img onClick="<?=$loanSeries?>" style="cursor:pointer;" title="View Employee Detailed Loan Payments" class="actionImg" src="../../../images/<?=$viewDetailed;?>" align="absbottom"></td>
	            </tr>
          		<tr> 
                      ...
                      <tr>
                        <td width="50%" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="1">
                            ...
                            <tr class="childGrid">
                              ...
                              <td class="gridDtlLbl">:</td>
                              <td class="gridDtlVal"><input class="inputs" name="loanRefNo" id="loanRefNo" value="<? echo $loanRefNo; ?>" <? echo $loanRefNo_dis; ?> type="text" size="25" maxlength="20"  onChange="valRefNo();"></td>
                            </tr>
                            <tr class="childGrid">
                            ...
                            <tr class="childGrid">
                              ...
                              <td class="gridDtlVal"><font class="periodLoan">
								...
								$maintEmpLoanObj->DropDownMenu(array('','1'=>'1st Period','2'=>'2nd Period','3'=>'Both'),'loanPeriod',$loanPeriod,'class="inputs"'); 
							?>
                              </font> </td>
                            </tr>
                            <tr class="childGrid">
