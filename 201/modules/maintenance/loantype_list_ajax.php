						...
						?>
								<tr bgcolor="<?php echo $bgcolor; ?>" <?php echo $on_mouse; ?>>
									...
									<td class="gridDtlVal" style="text-align: right;"><div align="center">
									  <div align="center"><a href="#" onClick="PopUp('loantype_act.php?act=EditLoanType&loantype=<?=$teuVal['lonTypeCd']?>','EDIT LOAN TYPE','<?=$dedListVal['recNo']?>','loantype_list_ajax.php','TSCont',<?=$intOffset?>,<?=$_GET['isSearch']?>,'txtSrch','cmbSrch')"><img src="../../../images/application_form_magnify.png" border="0" class="actionImg" title="View Detailed Info" /></a></div>
									</div></td>
								</tr>
							<?
								}
