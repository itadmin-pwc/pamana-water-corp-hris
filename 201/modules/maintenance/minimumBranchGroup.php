...
<SCRIPT>
	pager("minimumBranchGroup_list_ajax.php",'divMasterCont','load',0,0,'','','','../../../images/');  

	function maintDiv(act,branchMinimumGroupID,URL,ele,offset,isSearch,txtSrch,cmbSrch){
		...
		draggable:true })
		editDiv.setURL('minimumBranchGroup_act.php?action='+act+"&branchMinimumGroupID="+branchMinimumGroupID);
		editDiv.show(true);
		editDiv.showCenter();	
