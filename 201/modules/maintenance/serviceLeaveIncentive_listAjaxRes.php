...
$qryIntMaxRec = "SELECT * FROM view_leave_credit 
...
$qryEmpList = "SELECT * FROM view_leave_credit
		WHERE compCode= '{$sessionVars['compCode']}'
		$where_empStat $user_payCat_view "; 
        if($_GET['isSearch'] == 1){
        	if($_GET['srchType'] == 2){
			...
			<td class="parentGridDtl" valign="top">
				...
				<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
					...
					/*	if($_GET['action']=='Search'){
						...
						<INPUT class="inputs" type="button" name="btnSrch" id="btnSrch" value="SEARCH" onClick="pager('serviceLeaveIncentive_listAjaxRes.php','empMastCont','Search',0,1,'txtSrch','cmbSrch','&brnCd='+document.getElementById('brnCd').value,'','../../../images/')">
