...
$qryIntMaxRec = "SELECT * FROM tblDepartment 
        ...
        if($_GET['isSearch'] == 1){
        	if($_GET['srchType'] == 1){
        		$qryIntMaxRec .= "AND deptCode LIKE '{$_GET['txtSrch']}%' ";
        	}
        	if($_GET['srchType'] == 2){
...
$qryDivList = "SELECT * FROM tblDepartment
        ...
        if($_GET['isSearch'] == 1){
        	if($_GET['srchType'] == 1){
        		$qryDivList .= "AND deptCode LIKE '{$_GET['txtSrch']}%' ";
        	}
        	if($_GET['srchType'] == 2){
			...
			<td class="parentGridDtl" valign="top">
				...
				<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
					...
					<tr bgcolor="<?php echo $bgcolor; ?>" <?php echo $on_mouse; ?>>
						...
						<td class="gridDtlVal" align="center">
							<font class="gridDtlLblTxt">
								<a href="#" onclick="maintDept('EDIT','<?=$divListVal['deptCode']?>','department_dept_listAjaxRes.php','deptMasterCont',<?=$intOffset?>,<?=$_GET['isSearch']?>,'txtSrch','cmbSrch')"><img class="toolbarImg" src="../../../images/application_form_edit.png" title="Edit Department"></a>
							</font>
						</td>
					</tr>
					<?
