...
$qryIntMaxRec = "SELECT * from tblPayPeriod where compCode='{$_SESSION['company_code']}' and pdYear='".date("Y")."' and payCat='3'";
...
$qryPDList = "Select *,CASE pdStat WHEN 'H' THEN 'Held' WHEN 'O' THEN 'Open' END as status 
			  from tblPayPeriod 
			  where compCode='{$_SESSION['company_code']}' and pdYear='".date("Y")."' 
			  	and payCat='3' 
			  order by payGrp,payCat , pdNumber limit $intOffset,$intLimit";
				...
				<tr>
					<td class="parentGridDtl">
						...
						<INPUT class="inputs" type="button" name="btnSrch" id="btnSrch" value="SEARCH" onClick="pager('company_list_ajax.php','TSCont','Search',0,1,'txtSrch','cmbSrch','','../../../images/')">                              
							  ...
							  <td width="4%" class="gridDtlLbl" align="center">TS TAG</td>
								<td width="5%" class="gridDtlLbl" align="center">LOAN TAG</td>
							  <td width="8%" class="gridDtlLbl" align="center">EARNINGS TAG</td>
							  <td width="7%" class="gridDtlLbl" align="center">PROCESS TAG</td>
...
<td bgcolor="<?php echo $bgcolor; ?>" class="gridDtlVal"><div align="center">
							...
							<?}?>
							<tr>
								<td colspan="28" align="center" class="childGridFooter">
