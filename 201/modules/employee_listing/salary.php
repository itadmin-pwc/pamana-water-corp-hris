	...
	<BODY>
        <form name="frmTS" method="post" action="<? echo $_SERVER['../../../payroll/modules/special-reports/PHP_SELF']; ?>">
            ...
            <table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
           	 	<tr>
            		<td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Listing Report By Salary And Allowance</td>
            	</tr>
            			...
            			<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
            				<tr > 
            					<td class="gridToolbar" colspan="6"> 
            						...
            						<input name='fileName' type='hidden' id='fileName' value="payroll_type.php">                                </td>
            				</tr>
                            ...
                            <tr> 
                             ...
                             <tr>
                               ...
                               <td class="gridDtlVal"><? 					
										$arrpayCat = $inqTSObj->makeArr($inqTSObj->selectdpayCat(trim($_SESSION['user_payCat'])),'payCat','payCatDesc','');
										$inqTSObj->DropDownMenu($arrpayCat,'emppayCat',$emppayCat," class='inputs' ".$empSect_dis);
									?></td>
                             </tr>
                             <tr> 
       			    ...
       			    <br>
            			<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
            				<tr>
            					<td>
                                    <CENTER>
                                    	<input type="button" name="salary" id="salary" <? echo $btnpayrolltype_dis; ?> value="Generate Listing Report" onClick="valSearchTS(this.id);">
                                    </CENTER>
            					</td>
            				</tr>
            			</table> 
