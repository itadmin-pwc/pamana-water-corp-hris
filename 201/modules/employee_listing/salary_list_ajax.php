...
$reportPath = 'salary_pdf.php?payCat='.$payCat.'&empBrnCode='.$empBrnCode.'&fileName='.$fileName.'&empDept='.$empDept.'&empDiv='.$empDiv.'&empSect='.$empSect.'"';
			...
			<TABLE border="0" width="100%" cellpadding="1" cellspacing="0" class="parentGrid">
				<tr>
					<td colspan="4" class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">
                    		&nbsp;LISTING REPORT BY SALARY AND ALLOWANCE</td>
			  </tr>
				<tr>
