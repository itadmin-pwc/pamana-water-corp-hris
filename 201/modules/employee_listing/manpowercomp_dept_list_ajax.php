...
//$reportPath = 'payroll_type_pdf.php?&empBrnCode='.$empBrnCode.'&fileName='.$fileName.'&empDept='.$empDept.'&empDiv='.$empDiv.'&empSect='.$empSect.'"';
$reportPath = 'manpowercomp_dept_pdf.php?&empBrnCode='.$empBrnCode.'&fileName='.$fileName.'&empDept='.$empDept.'&empDiv='.$empDiv.'&empRank='.$empRank.'&empStatus='.$empStatus.'&monthfr='.$monthfr.'&monthto='.$monthto.'"';
					...
					<td class="parentGridDtl">
						<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
						  	<td colspan="27" class="gridToolbar" align="">
								<input name="back" type="button" id="back" value="Back" onClick="location.href='manpowercomp_dept.php';">
              				</td>
