...
$reportPath = 'payroll_type_excel.php?&empBrnCode='.$empBrnCode.'&fileName='.$fileName.'&empDept='.$empDept.'&empDiv='.$empDiv.'&empSect='.$empSect.'"';
			...
			<TABLE border="0" width="100%" cellpadding="1" cellspacing="0" class="parentGrid">
				<tr>
					<td colspan="4" class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">
                    		&nbsp;LISTING REPORT BY PAYROLL TYPE
                    </td>
				</tr>
				<tr>
					<td class="parentGridDtl">
						<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
						  	<td colspan="27" class="gridToolbar" align="">
								<input name="back" type="button" id="back" value="Back" onClick="location.href='payroll_type.php';">
              				</td>
