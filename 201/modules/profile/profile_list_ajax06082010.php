...
$qryEmpList = "SELECT TOP $intLimit *
		...
		and empPayCat<>0 $user_payCat_view and
		empNo NOT IN
        (SELECT TOP $intOffset empNo FROM tblEmpMast WHERE empStat NOT IN('RS','IN','TR') $user_payCat_view and compCode = '{$sessionVars['compCode']}' and empPayCat<>0 $brnCodelist "; 
					...
					<tr  bgcolor="<?php echo $bgcolor; ?>" <?php echo $on_mouse; ?>>
                        ...
                        <td class="gridDtlVal" >
							...
							?>
								...
								<a href="#" onClick="location.href='profile_employee_allowance.php?transType=list&empNo=<?=$empListVal['empNo']?>'"><img class="toolbarImg" src="../../../images/allowance_list.png" title="Employee Allowance"></a>
