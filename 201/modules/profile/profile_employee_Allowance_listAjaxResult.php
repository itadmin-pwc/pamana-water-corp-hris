...
<div class="niftyCorner">
            ...
            <!--<td  class="gridDtlLbl" align="center" width="10%">TAX TAG</td>-->
					...
					<tr bgcolor="<?php echo $bgcolor; ?>" <?php echo $on_mouse; ?>>
                        ...
                        <td class="gridDtlVal"><font class="gridDtlLblTxt"><?php
						if($empAllwListVal['allowTag']=="M"){
							echo "MONTHLY";	
						}
						elseif($empAllwListVal['allowTag']=="D"){
							echo "DAILY";	
						}
						else{
							echo "";	
						}
						// echo ($empAllwListVal['allowTag']!="M"?"DAILY":"MONTHLY");
						 ?></font></td>
