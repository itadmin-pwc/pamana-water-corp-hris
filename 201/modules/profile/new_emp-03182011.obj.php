...
//		$newempcode=$this->createempno($this->compCode);
		...
		echo $qryAddEmployee = "INSERT INTO $tbl (
							$genfields
							$confields
							$perfields
							$idfields
	...
	function viewprofile($empNo) {
		...
		, Day(empEndDate) as empEndDate_D , Month(empEndDate) as empEndDate_M, Year(empEndDate) as empEndDate_Y,empstat as status from tblEmpMast_new where empNo='$empNo' and compCode='{$this->oldcompCode}'";
...
//			$this->Release=$profile[''];
	...
	function releaseEmp($empNo,$compCode) {
		$sqlRelease = "Insert into tblEmpMast (compCode, empNo, empLastName, empFirstName, empMidName, empLocCode, empBrnCode, empDiv, empDepCode, 
										  empSecCode, empPosId, dateHired, empStat, dateReg, dateResigned, empRestDay, empTeu, empTin, empSssNo, empPagibig, empBankCd, 
										  empAcctNo, empPayGrp, empPayType, empPayCat, empWageTag, empPrevTag, empAddr1, empAddr2, empAddr3, empMarStat, empSex, empBday, 
										  empReligion, empMrate, empDrate, empHrate, empOtherInfo, empNickName, empBplace, empHeight, empWeight, empCitizenCd, empBloodType, 
										  empEndDate, empLevel, empSubSection, empCityCd, empSpouseName, empBuildDesc, empComplexDesc, empEyeColorDesc, empHairDesc, 
										  empPhicNo, empAbsencesTag, empLatesTag, empUtTag, empOtTag, empPicture, empImageSize, empShiftId, annualTag, empRank,releasedby,empdateadded,id)
					SELECT compCode, empNo, empLastName, empFirstName, empMidName, empLocCode, empBrnCode, empDiv, empDepCode, 
										  empSecCode, empPosId, dateHired, empStat, dateReg, dateResigned, empRestDay, empTeu, empTin, empSssNo, empPagibig, empBankCd, 
										  empAcctNo, empPayGrp, empPayType, empPayCat, empWageTag, empPrevTag, empAddr1, empAddr2, empAddr3, empMarStat, empSex, empBday, 
										  empReligion, empMrate, empDrate, empHrate, empOtherInfo, empNickName, empBplace, empHeight, empWeight, empCitizenCd, empBloodType, 
										  empEndDate, empLevel, empSubSection, empCityCd, empSpouseName, empBuildDesc, empComplexDesc, empEyeColorDesc, empHairDesc, 
										  empPhicNo, empAbsencesTag, empLatesTag, empUtTag, empOtTag, empPicture, empImageSize, empShiftId, annualTag, empRank,'{$_SESSION['user_id']}',empdateadded,id
					FROM tblEmpMast_new where empNo='$empNo' AND compCode='$compCode'";
			
		$sqlUpdateReleased = "Update tblEmpMast_new set stat='R',datereleased='".date('m/d/Y')."',userReleased='{$_SESSION['user_id']}' where empNo='$empNo' AND compCode='$compCode'";
