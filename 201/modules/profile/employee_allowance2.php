...
<SCRIPT>
	pager('employee_Allowance_listAjaxResult.php','empAllowList','load',0,0,'','','&empNo=<?=$_GET['empNo']?>','../../../images/');  
	...
	function maintAllow(act,empNo,allwCode,URL,ele,empNo,allwCode,offset,maxRec,isSearch,txtSrch,cmbSrch){
		...
		draggable:true })
		editAllw.setURL('maintain_employee_allowance.php?transType='+act+'&empNo='+empNo+"&allwCode="+allwCode);
		editAllw.show(true);
		editAllw.showCenter();	
