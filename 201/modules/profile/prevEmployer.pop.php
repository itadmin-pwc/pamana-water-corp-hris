<?
	...
	*/
	...
	if($_GET['btnCont6'] == 'Edit')
	{
		...
		if($chkEmployerTin>0)
		{
			$chkAgainTin =  $mainContent6Obj->chkAgainTin($_GET["txtTinNo"],$empNo,$_GET["seqNo"]);
			if($chkAgainTin==0)
			{
				$chkEmployerTin =  $mainContent6Obj->chkTinEmployer($_GET["txtTinNo"],$empNo,$_SESSION['oldcompCode']);
				if($chkEmployerTin>0)
        	...
        	<?php
				echo "<table border='0' width='100%' cellpadding='1' cellspacing='1' class='childGrid'>\n";
					...
					echo "<tr>\n";
							...
							echo "<td width='1%' class='gridDtlLbl' align='center'>:</td>";
							echo "<td  width='59%' class='gridDtlVal'><input type='text' class='inputs' name='txtTinNo' id='txtTinNo' maxlength='11' value=".$txtTinNo."></td>\n";
					echo "</tr>\n";
...
<script>
	function validation()
	{
		...
		if(!frmpopContent6["txtTinNo"].match(tinExp))
		{
