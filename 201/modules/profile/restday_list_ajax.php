				...
				<tr>
					<td>
						<TABLE border="0" width="100%" cellpadding="1" cellspacing="0">
                            ...
                            <tr><td colspan="2"><div style="height:77px; width:100%; overflow: auto;">
							...
							<tr class="rowDtlEmplyrLst">
								<td class="gridDtlVal" width="44%"><div align="center"><font class="gridDtlLblTxt">
							    <?=$restDayList[$x];?>
							    </font></div></td>
								 <td class="gridDtlVal" align="center" width="40%">
								<? //if($_GET["disPayGrp"]=="")  {?>
                               <img onClick="delrestday('<?=$restDayList[$x];?>')"
												src="../../../images/prev_emp_dele.png" width="15" height="15" title="Delete Rest Day" />
          						<?}?>
                                </td>
						  </tr>
							<?
							...
							?>
							<tr>
								<td colspan="2" align="center"><FONT class="zeroMsg">NOTHING TO DISPLAY</font></td>
							</tr>
                            <?
                            }
							?>
