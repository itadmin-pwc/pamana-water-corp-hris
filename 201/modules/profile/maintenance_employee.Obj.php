...
class maintEmpObj extends commonObj {
	...
	function updateEmployee(){
		...
		$qryUpdtUserLogInInfo = "UPDATE tblUsers SET userLevel = '{$this->userLevel}',dateUpdt = '".date("Y-m-d")."'
							     WHERE compCode = '{$this->hdnCompCode}'
							     AND empNo = '".trim($this->empNo)."' ";
...
class employeeAllowanceObj extends commonObj {
	...
	function addEmpAllowance(){
		 ...
		 $qryToEmpAllowance = "INSERT INTO tblPAF_Allowance(
								...
								stat
							  	...
							  	'".(float)$this->method['txtAllwAmountold']."','{$this->method['txtAllwAmount']}','".($_GET['action']=='EDIT'?$_GET['allow_edit_sked']:$this->method['cmbAllwSked'])."','{$this->method['cmbAllwTaxTag']}',
								...
								'".date('Y-m-d')."',								
								'{$_SESSION['user_id']}',
								'".($_GET['action']=='EDIT'?$_GET['allow_edit_tag']:$this->method['allowTag'])."',
								'".$this->getAllowInfo(($_GET['action']=='EDIT'?$_GET['allow_edit_code']:$this->method['AllowType']))."',
								'H'
							  )";
	...
	function editEmpAllowance(){
		 $qryEditEmpAllow = "UPDATE tblPAF_Allowance SET allowAmt    	= '{$this->method['txtAllwAmount']}',
													...
													allowTag			= '".($_GET['action']=='EDIT'?$_GET['allow_edit_tag']:$this->method['allowTag'])."',
