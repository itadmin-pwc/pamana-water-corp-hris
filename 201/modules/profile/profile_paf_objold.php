...
//								}
					...
					case "allow":
						...
						$resAllw = $this->getArrResI($this->execQryI($qryAllow));
				...
				if($qryempMastInsert!=""){
					$Trns = $this->execQryI($qryempMastInsert);	
				}
				if($qryempMastUpdate!=""){
					$Trns = $this->execQryI($qryempMastUpdate);	
				}
	...
	function rollbackPAF(){
		...
		return $this->execQry($qryRollBackPAF);
	}
