                  ...
                  <tr>
                    ...
                    <tr>
                      <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
                        ...
                        <tr>
                          ...
                          <td>
                            <div align="left">
                              <?$maintEmpObj->DropDownMenu(array("0"=>"",'RG'=>'Regular','PR'=>'Probationary','CN'=>'Contractual','RS'=>'Resigned','TR'=>'Terminated','IN'=>'Inactive','AP'=>'Applicant'),'cmbempstatus',$empStat_new,'class="inputs" style="width:180px;"' ); ?>
                      ...
                      <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
                        ...
                        <tr>
                          ...
                          <td>
                              <div align="left">
                                <?
                              $maintEmpObj->DropDownMenu($maintEmpObj->makeArr($maintEmpObj->getBranch($compCode),'brnCode','brnDesc',''),'cmbbranch',$Branch_new,'class="inputs" style="width:180px;"');?>
                    ...
                    <tr>
                      <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
                        ...
                        <tr>
                          <td height="20" colspan="4" class=" style1"><div align="center"><span style="cursor:pointer" onClick="location.href='profile_transaction.php?act=empstat&frmRefNo=<?=$refno['refno']?>&empNo=<?=$empNo?>&compCode=<?=$compCode?>'" class="style5" align="right">Employee Status </span>| <span style="cursor:pointer" onClick="location.href='profile_transaction.php?act=branch&frmRefNo=<?=$refno['refno']?>&empNo=<?=$empNo?>&compCode=<?=$compCode?>'" class="style5" align="right"> Branch</span> | <span style="cursor:pointer" onClick="location.href='profile_transaction.php?act=payroll&frmRefNo=<?=$refno['refno']?>&empNo=<?=$empNo?>&compCode=<?=$compCode?>'" class="style5" align="right"> Payroll Related</span> | <span style="cursor:pointer" onClick="location.href='profile_transaction.php?act=others&frmRefNo=<?=$refno['refno']?>&empNo=<?=$empNo?>&compCode=<?=$compCode?>'" class="style5" align="right"> Others</span>   <span style="cursor:pointer" onClick="location.href='profile_transaction.php?act=empstat&frmRefNo=<?=$refno['refno']?>&empNo=<?=$empNo?>&compCode=<?=$compCode?>'" class="style5" align="right"></span>| <span style="cursor:pointer" onClick="viewDetails('employee_allowance.php?empNo=<?=$_GET['empNo']?>&refNo='+document.getElementById('refno').value+'&controlNo='+document.getElementById('ctrlno').value+'&effectivitydate='+document.getElementById('txtposDate').value,'Add','','contact_list_ajax.php','TSCont',0,0,'txtSrch','cmbSrch')" class="style5" align="right"> Allowance</span></div></td>
                        </tr>
                      </table></td>
                    </tr>
                    <? } elseif ($act == "payroll") {
                      ...
                      <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
                        <tr>
                          ...
                          <td colspan="3"><table width="73%" border="0" align="right" cellpadding="0" cellspacing="0">
                            <tr>
                              <td width="36%">&nbsp;</td>
                              <td width="59%"><div align="left">
                                <input name="button" type="button" onClick="payroll()" class="inputs" id="button2" value="Save">
                        ...
                        <tr>
                          ...
                          <td>
                              <div align="left">
                                <label>
                                <input name="txtsalary" onBlur="checkECOLA();round_number()" style="width:180px;" type="text" value="<?=$payMrate?>" readonly onKeyUp="return computeRates(this.value,<?=$compCode?>,'1');"  class="inputs" onKeyPress="return isNumberInput2Decimal(this, event);" id="txtsalary">
                                </label>
                        ...
                        <tr>
                          ...
                          <td>
                              <div align="left">
                                <input class='inputs' onKeyPress="return isNumberInput2Decimal(this, event);"  onBlur="checkECOLA();round_number()" type="text" style="width:180px;" value="<?=$payDrate?>" onKeyUp="return computeRates(this.value,<?=$compCode?>,'0');"  name="txtdailyrate" id="txtdailyrate" readonly />
                        ...
                        <tr>
                          ...
                          <td>
                            <div align="left">
                              <input class='inputs' type="text" onKeyPress="return isNumberInput2Decimal(this, event);" value="<?=$payAcctNo?>"  name="txtbankaccount" id="txtbankaccount" onBlur="checkno('empAcctNo',this.value,'0','Account No.','dvAcctNo')" style="width:180px;" /><br><span id="dvAcctNo" style="color:#FF0000;font-size:10px"></span><input type="hidden" name="chAcctNo" id="chAcctNo">
                        ...
                        <tr>
                          ...
                          <td><div align="center" class="headertxt" >
                              <div align="left">
                                <?=$empother_info['empPayGrp'];?>
                                  </div>
                          </div></td>
                          <td>
                              <div align="left">
                                <?$maintEmpObj->DropDownMenu(array('','Group 1','Group 2'),'cmbgroup',$payPayGrp,'class="inputs" style="width:180px;"'); ?>
                                <input type="hidden" value="<?=$empProf['empPayGrp']?>" name="oldpaygroup" id="oldpaygroup">
                            </div></td>
                        </tr>
                        <tr>
                    ...
                    <tr>
                      <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
                        <tr>
                          ...
                          <td colspan="2"><table width="72%" border="0" align="right" cellpadding="0" cellspacing="0">
                              <tr>
                                <td width="36%">&nbsp;</td>
                                <td width="59%"><div align="left">
                                  <input name="button2" type="button" onClick="others()" class="inputs" id="button3" value="Save">
                                  <input name="button9" type="button" onClick="location.href = 'profile_actionlist.php?empNo=<?=$empNo?>&compCode=<?=$compCode?>'" class="inputs" id="button10" value="Cancel/Exit">
                                </div></td>
                              </tr>
                          </table></td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td><div align="left">
                              <input class='inputs' maxlength="10" type="text" value="<?=$othsss ?>" onBlur="checkno('empSssNo',this.value,'0','SSS No.','dvsss')"  name="txtsss" id="txtsss" style="width:180px;" /><input type="hidden" name="chsss"  value="" id="chsss">
                        ...
                        <tr>
                          ...
                          <td><div align="left">
                              <input class='inputs' onKeyPress="return isNumberInput2Decimal(this, event);" maxlength="25" type="text" value="<?=$othphil  ?>" onBlur="checkno('empPhicNo',this.value,'0','Philhealth No.','dvphilhealth')" name="txtphilhealth" style="width:180px;" id="txtphilhealth" /><input type="hidden"  name="chphilhealth" value="" id="chphilhealth">
                              <input type="hidden" value="<?=$empProf['empPagibig']?>" name="old_txtphilhealth" id="old_txtphilhealth">
                          </div></td>
                        </tr>
                        <tr>
                          ...
                          <td><div align="left">
                              <input class='inputs' maxlength="9" type="text" style="width:180px;" value="<?=$othtin ?>" onBlur="checkno('empTin',this.value,'0','Tax ID No.','dvtaxid')"  name="txttax" id="txttax" /><input type="hidden" name="chtaxid" value="" id="chtaxid">
                        ...
                        <tr>
                          ...
                          <td><div align="left">
                              <input class='inputs' style="width:180px;" maxlength="25" onKeyPress="return isNumberInput2Decimal(this, event);" type="text" value="<?=$othhdmf ?>" onBlur="checkno('empPagibig',this.value,'0','HDMF No.','dvhdmf')"  name="txthdmf" id="txthdmf" /><input type="hidden" name="chhdmf" value="" id="chhdmf">
...
*/		params = 'profile_transaction.php';
	...
	function payroll() {
		...
		if(empInputs['txtsalary'] !=0) {
			...
			if (new_sal < old_sal) {
				alert('New Monthly Rate is less than the Old Monthly Rate.');
				$('txtsalary').focus();
				$('txtsalary').select();
				return false;		
			}
