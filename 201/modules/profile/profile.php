               ...
               <div id="content2" class="content2" style="height: 520px;">
                   <TABLE align="center" cellpadding="0" cellspacing="2" border="0" class="childGrid" width="100%">
					  ...
					  <tr> 
						...
						<td class="headertxt">:</td>
						<td class="gridDtlVal" valign="top">
							<select class="inputs" name="cmbRegion" id="cmbRegion">
								<option value=""></option> 
					  ...
					  <tr> 
						...
						<td class="headertxt">:</td>
						<td class="gridDtlVal" valign="top"><input value="<?=$maintEmpObj->empZipCode?>" size="10" name="txtZipCode" type="text" class="inputs" maxlength="150" id="txtZipCode" /></td>
					  </tr>
					  <tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td class="headertxt">:</td>
                        <td class="gridDtlVal" valign="top"><input value="<?=$maintEmpObj->empECRelation?>" size="20" name="txtRelationship" type="text" class="inputs" maxlength="150"  id="txtRelationship"/></td>
                      </tr>
                      <tr>
					  ...
					  <tr>
                        ...
                        <td class="headertxt">:</td>
                        <td class="gridDtlVal" valign="top"><input value="<?=$maintEmpObj->empECNumber2?>" size="15" name="txtECNumber2" type="text" class="inputs" maxlength="15" id="txtECNumber2"/></td>
                      </tr>
					  <tr>
