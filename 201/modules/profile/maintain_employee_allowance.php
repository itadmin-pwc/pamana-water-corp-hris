...
if($_GET['transType'] == 'Edit'){
	...
	if ($_GET['code'] != 1) {
		...
		$effDate	  = date('Y-m-d',strtotime($SpcfcEmpAllow['effectivitydate']));
				...
				<TABLE border="0" width="100%" height="95%" cellpadding="1" cellspacing="1" class="childGrid" >
					...
					<tr>
						...
						<td class="gridDtlVal">
                            ...
                            <input type="hidden" value="<?=$allwSked?>" name="allow_edit_sked" id="allow_edit_sked">
                            	</td>
					</tr>
					<tr>
						<td class="gridDtlLbl" align="left" >
						...
						<td class="gridDtlVal">
                            ...
                            <input type="hidden" value="<?=$allowTag?>" name="allow_edit_tag" id="allow_edit_tag">			
                      	</td>
					</tr>
<!--					<tr>
						<td class="gridDtlLbl" align="left" >
					...
					<tr>
					  ...
					  <td class="gridDtlVal">
							...
							?>						<input type="hidden" value="<?=date('Y-m-d');?>" name="today" id="today">
