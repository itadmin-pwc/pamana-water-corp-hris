...
class blackListObj extends commonObj {
	...
	{
		$qryChecked = "Select * from payroll_company..tblBlacklistedEmp where blacklist_No='".$empNo."'";
	...
	{
		$qryChecked = "Select empNo,replace(empLastName,'Ñ','N') as emprLname, replace(empFirstName,'Ñ','N') as emprFname, replace(empMidName,'Ñ','N') as emprMidName, * from payroll_company..tblBlacklistedEmp where blacklist_No='".$blacklist_id."'";
		$res_Checked  = $this->execQry($qryChecked);
	...
	function insEmptblBlackListed($empNo,$reason,$agency,$empencoded,$get_empLname,$get_empFname,$get_empMname,$get_empBDate,$get_empSssNo,$get_empTinNo,$get_empBrnCode,$get_empDateHired,$get_empDateResigned,$get_empCompCode,$get_empDept,$get_empPos)
	{
		...
		$insQry = "Insert into payroll_company..tblBlacklistedEmp(empNo,empLastName,empFirstName,empMidName,
	...
	{
		$updQry = "Update payroll_company..tblBlacklistedEmp set reason='".strtoupper($reason)."', agency='".strtoupper($agency)."', updatedBy='".$empencoded."', dateUpdated='".date("Y-m-d")."'
	...
	{
		$delQry = "Delete from payroll_company..tblBlacklistedEmp where blacklist_No='".$blackListNo."'";
