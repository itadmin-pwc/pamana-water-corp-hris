	...
	<TABLE border="0" width="100%" cellpadding="1" cellspacing="0" class="parentGrid">
		<tr>
			<td colspan="4" class="parentGridHdr">
				&nbsp;<img src="../../../images/grid.png">&nbsp;Employee Current Allowance List (<?=$userInfo['empNo'] ." - " . $userInfo['empFirstName'] . " " . $userInfo['empMidName'] . " " . $userInfo['empLastName']?>) (<?=($userInfo['empPayType']=='M') ? 'Monthly' : 'Daily';?>)
			</td>
		</tr>
		<tr>
			<td class="parentGridDtl" >
				<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
					<td colspan="10" class="gridToolbar">
						<a href="#"  class="anchor" onclick="maintAllow('Add','<?=$_GET['empNo']?>&refNo=<?=$_GET['refNo']?>&controlNo=<?=$_GET['controlNo']?>&effectivitydate=<?=$_GET['effectivitydate']?>','','employee_Allowance_listAjaxResult.php','empAllowList','<?=$empAllwListVal['allowCode']?>&refNo=<?=$_GET['refNo']?>&controlNo=<?=$_GET['controlNo']?>&effectivitydate=<?=$_GET['effectivitydate']?>',<?=$intOffset?>,'',<?=$_GET['isSearch']?>,'txtSrch','cmbSrch')">
...
$qryEmpAllwList = "SELECT allw.compCode,allw.empNo,allw.allowCode,allw.allowAmt,allw.allowAmtold,allw.allowSked,allw.controlNo,
						                allw.allowTaxTag,allw.allowPayTag,allw.allowStart,allw.allowEnd,allw.allowStat,
					  ...
					  <td class="gridDtlVal" align="center"><font class="gridDtlLblTxt">
					    <?
									if(date('Y-m-d',strtotime($empAllwListVal['effectivitydate'])) == '0000-00-00'){
										...
										echo date('Y-m-d',strtotime($empAllwListVal['effectivitydate']));
									}
								?>
					  </font></td>
						<td class="gridDtlVal" align="center">

							<a href="#" onClick="maintAllow('Edit','<?=$empAllwListVal['empNo']?>&refNo=<?=$_GET['refNo']?>&controlNo=<?=$empAllwListVal['controlNo']?>&effectivitydate=<?=$empAllwListVal['effectivitydate']?>','<?=$empAllwListVal['allowCode']?>','employee_Allowance_listAjaxResult.php','empAllowList','<?=$empAllwListVal['allowCode']?>&refNo=<?=$_GET['refNo']?>&controlNo=<?=$_GET['controlNo']?>&effectivitydate=<?=$_GET['effectivitydate']?>',<?=$intOffset?>,'',<?=$_GET['isSearch']?>,'txtSrch','cmbSrch')"><img class="toolbarImg" src="../../../images/application_form_edit.png" title="Edit"></a>
