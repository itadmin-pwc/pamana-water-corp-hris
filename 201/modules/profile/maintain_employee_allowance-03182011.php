					...
					<tr>
						...
						<td class="gridDtlVal">
							...
							$EmpAllowObj->DropDownMenu($EmpAllowObj->makeArr(
								...
								'AllowType',$allowType,'class="inputs" ' 
							);
					...
					<tr>
						...
						<td class="gridDtlVal">
							...
							$EmpAllowObj->DropDownMenu(array(
								...
								),'cmbAllwSked',$allwSked,'class="inputs" onchange="validateSched(this.value)"'
							);
							?>						</td>
					</tr>
					<tr>
						...
						<td class="gridDtlVal">
							<?
							$EmpAllowObj->DropDownMenu(array('M'=>'MONTHLY','D'=>'DAILY'),'allowTag',$allowTag,'class="inputs" ');
							?>						</td>
					</tr>
<!--					<tr>
						<td class="gridDtlLbl" align="left" >
