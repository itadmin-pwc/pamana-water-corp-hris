...
<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
	<td colspan="7" class="gridToolbar">
		...
		<INPUT class="inputs" type="button" name="btnSrch" id="btnSrch" value="SEARCH" onclick="pager('../profile/employee_lookupAjaxResult.php','empLukupCont','Search',0,1,'txtSrch','cmbSrch','','../../../images/')">
	</td>
	<tr>
	...
	<tr>
		<td colspan="7" align="center" class="childGridFooter">
			<? $pager->_viewPagerButton('../profile/employee_lookupAjaxResult.php','empLukupCont',$intOffset,$_GET['isSearch'],'txtSrch','cmbSrch','&tmpCompCode='.$_GET['tmpCompCode']);?>
		</td>
	</tr>
</TABLE>
