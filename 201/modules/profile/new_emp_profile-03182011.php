              ...
              <div id="content3" class="content3">
				...
				<TABLE align="center" cellpadding="0" cellspacing="2" border="0" class="childGrid" width="100%">
                      ...
                      <tr>
                        ...
                        <td class="headertxt">:</td>
                        <td class="gridDtlVal"><input class='inputs' maxlength="11" type="text" value="<?=$maintEmpObj->TIN?>" onKeyDown="javascript:return dFilter (event.keyCode, this, '###-###-###');" onBlur="checkno('empTin',this.value,'<?=$notype?>','Tax ID No.','dvtaxid')"  name="txttax" id="txttax" />&nbsp;<span id="dvtaxid" style="color:#FF0000; font-size:10px"></span><input type="hidden" name="chtaxid" value="" id="chtaxid"></td>
                        </tr>
                      <tr>
...
<tr>
                              ...
                              <tr>
                                ...
                                <td class="headertxt">:</td>
                                <td class="gridDtlVal"><?$maintEmpObj->DropDownMenu(array("0"=>"",'RG'=>'Regular','PR'=>'Probationary','CN'=>'Contractual','RS'=>'Resigned','TR'=>'Terminated','IN'=>'Inactive','AP'=>'Applicant','EOC'=>'End of Contract','AWOL'=>'AWOL'),'cmbstatus',$maintEmpObj->Status,'class="inputs" style="width:222px;"'); ?></td>
                              </tr>
                              <tr>
                      ...
                      <tr> 
                        <td align="left" class="parentGridDtl" height="300" valign="top"><table width="90%" border="0" cellspacing="1" cellpadding="2">
                          ...
                          <tr>
                            ...
                            <td width="1%" class="headertxt">:</td>
                            <td class="gridDtlVal"><div id="dvsalary"><input class='inputs' type="text" value="<?=$maintEmpObj->Salary?>" style="<?=$visible?>"  name="txtsalary" onKeyPress="return computeRates(this.value,<?=$maintEmpObj->compCode?>,'1',event);" maxlength="9" id="txtsalary" readonly /></div></td>
                          </tr>
                          <tr>
                            <td width="26%" class="headertxt">Daily Rate</td>
                            <td width="1%" class="headertxt">:</td>
                            <td class="gridDtlVal"><div id="dvdailyrate"><input class='inputs' type="text" value="<?=$maintEmpObj->Drate?>" style="<?=$visible?>" onKeyPress="return computeRates(this.value,<?=$maintEmpObj->compCode?>,'0',event);"  name="txtdailyrate" maxlength="9" id="txtdailyrate" readonly /></DIV></td>
                          </tr>
                          <tr>
