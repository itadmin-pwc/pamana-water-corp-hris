...
<SCRIPT>
	pager('employee_Allowance_listAjaxResult.php','empAllowList','load',0,0,'','','&empNo=<?=$_GET['empNo']?>&refNo=<?=$_GET['refNo']?>&controlNo=<?=$_GET['controlNo']?>&effectivitydate=<?=$_GET['effectivitydate']?>','../../../images/');  
