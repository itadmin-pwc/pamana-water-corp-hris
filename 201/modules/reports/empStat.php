...
<form name="frmTS" method="post" action="<? echo $_SERVER['PHP_SELF']; ?>">
  <table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
    <tr>
      ...
      <td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Employee Status 
        Reports</td>
	</tr>
	<tr>
		<td class="parentGridDtl" >
          ...
          <tr > 
            <td class="gridToolbar" colspan="7"> <input name="hide_option" type="hidden" id="hide_option" value="<? echo $option_menu; ?>"> 
              ...
              <input name='orderBy' type='hidden' id='orderBy'></td>
          </tr>
          
          <tr>
            <td class="gridDtlLbl">Status</td>
            <td class="gridDtlLbl">:</td>
            <td width="10%" class="gridDtlVal"><font class="byOrder">
              <?$inqTSObj->DropDownMenu(array("0"=>"",'RG'=>'Regular','PR'=>'Probationary','CN'=>'Contractual','RS'=>'Resigned','TR'=>'Terminated','IN'=>'Transfer','AP'=>'Applicant'),'cmbType',$_POST['cmbType'],'class="inputs"' . $empSect_dis); ?>
            </font></td>
