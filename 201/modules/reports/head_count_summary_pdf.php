...
####Set up details/data	
	function Data($arrRank) {
		...
		$this->Cell(110,5,'HEAD OFFICE BASED','1','1');
			...
			$qryHO = "Select empStat,empRank,count(empRank)rankCnt,employmentTag as empTag  from tblEmpMast emp inner join tblRankType rank on emp.empRank = rank.rankCode where empBrnCode='0001' and empStat IN ('RG','RS') group by empStat,empRank,employmentTag order by empStat,empRank";
		...
		$this->Cell(110,5,'STORE BASED','1','1');
			...
			$qrySB = "Select empStat,empRank,count(empRank)rankCnt,employmentTag as empTag from tblEmpMast emp inner join tblRankType rank on emp.empRank = rank.rankCode where empBrnCode<>'0001' and empStat IN ('RG','RS') and emp.empDiv<>'7' group by empStat,empRank,employmentTag order by empStat,empRank";
		...
		//$this->Cell(15,5,(int)$totexecHO+(int)$totexecSB,'1',1,'C','0');	
		...
		$this->Cell(110,3,'','1','1');
			$qrySO = "Select empStat,empRank,count(empRank)rankCnt,employmentTag as empTag from tblEmpMast emp inner join tblRankType rank on emp.empRank = rank.rankCode where empBrnCode<>'0001' and  empStat IN ('RG','RS') and emp.empDiv='7' group by empStat,empRank,employmentTag order by empStat,empRank";
