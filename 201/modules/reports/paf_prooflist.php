...
<form name="frmTS" method="post" action="<? echo $_SERVER['PHP_SELF']; ?>">
  <table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
    <tr>
      ...
      <td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;PAF Proof List</td>
	</tr>
	<tr>
		<td class="parentGridDtl" >
          ...
          <tr > 
            <td class="gridToolbar" colspan="7"> <input name="hide_option" type="hidden" id="hide_option" value="<? echo $option_menu; ?>"> 
              ...
              <input name='fileName' type='hidden' id='fileName' value="paf_prooflist.php">            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="gridDtlLbl">:</td>
            <td width="18%" class="gridDtlVal"><input value="" type='text' onChange="valDateStartEnd(this.value,this.id,document.frmTS.txttoDate.value);" class='inputs' name='txtfrDate' id='txtfrDate' maxLength='10' readonly size="10"/>
            ...
            <td width="63%" class="gridDtlVal">&nbsp;</td>
          </tr>
          <tr>
          ...
          <tr> 
            <td class="gridDtlLbl">Checking Officer</td>
            <td class="gridDtlLbl">:</td>
            <td colspan="2" class="gridDtlVal">
            <? 					
					$arrDept = $inqTSObj->makeArr($inqTSObj->getDivArt($compCode),'divCode','deptDesc','');
