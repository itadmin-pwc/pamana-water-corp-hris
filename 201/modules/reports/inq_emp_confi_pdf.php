...
$pdf->repTitle = "Employee Personnel Information (Confidentials)";
$pdf->refNo    = "";
$pdf->dtlLabelUp    = "";
...
$position  = $maintEmpObj->getpositionwil(" where posCode='".$dispEmp['empPosId']."'",2);
...
if ($dispEmp['employmentTag']=="RG") { $empStat = "Regular"; } 
if ($dispEmp['employmentTag']=="PR") { $empStat = "Probationary"; }
if ($dispEmp['employmentTag']=="CN") { $empStat = "Contractual"; }
...
$pdf->Cell(65,$SPACES,$dispEmp['empNo'],0,0);
$pdf->Cell(50,$SPACES,"Branch              :",0,0);
$pdf->Cell(65,$SPACES,$brnchName['brnShortDesc'],0,1);

$pdf->Cell(40,$SPACES,"Name            :",0,0);
$pdf->Cell(65,$SPACES,$dispEmp['empLastName']." ".$dispEmp['empFirstName']." ".$dispEmp['empMidName'],0,0);
$pdf->Cell(50,$SPACES,"Position            :",0,0);
$pdf->MultiCell(50,$SPACES,$position['posDesc'],0,1);	

$pdf->Cell(40,$SPACES,"Division        :",0,0);
$pdf->Cell(65,$SPACES,$dispDivDesc['deptShortDesc'],0,0);
$pdf->Cell(50,$SPACES,"Date Hired          :",0,0);
$pdf->Cell(65,$SPACES,$maintEmpObj->valDateArt($dispEmp['dateHired']),0,1);

$pdf->Cell(40,$SPACES,"Department      :",0,0);
$pdf->Cell(65,$SPACES,$dispDeptDesc['deptShortDesc'],0,0);
$pdf->Cell(50,$SPACES,"Employee Status     :",0,0);
$pdf->Cell(65,$SPACES,$empStat,0,1);

$pdf->Cell(40,$SPACES,"Section         :",0,0);
$pdf->Cell(65,$SPACES,$dispSectDesc['deptShortDesc'],0,0);
$pdf->Cell(50,$SPACES,"Regularization Date :",0,0);
$pdf->Cell(65,$SPACES,$maintEmpObj->valDateArt($dispEmp['dateReg']),0,1);

$pdf->Cell(40,$SPACES,"Group           :",0,0);
$pdf->Cell(65,$SPACES,$grpName,0,0);
$pdf->Cell(50,$SPACES,"Pay Status Type     :",0,0);
$pdf->Cell(65,$SPACES,$payStatus,0,1);

$pdf->Cell(40,$SPACES,"Category        :",0,0);
$pdf->Cell(65,$SPACES,$catName['payCatDesc'],0,0);
$pdf->Cell(50,$SPACES,"Location            :",0,0);
$pdf->Cell(65,$SPACES,$locName['brnShortDesc'],0,1);
$pdf->Ln(10);

#########################################################################
$pdf->Line(11,$pdf->GetY(),$TOTAL_WIDTH+6,$pdf->GetY());  /////(X1,Y1,X2,Y2)			  ####### LINE LINE LINE
$pdf->Ln(3);
$pdf->Cell($TOTAL_WIDTH,$SPACES,"A C C O U N T   I N F O R M A T I O N",0,1);
$pdf->Line(11,$pdf->GetY(),$TOTAL_WIDTH+6,$pdf->GetY());  /////(X1,Y1,X2,Y2)			  ####### LINE LINE LINE
#########################################################################
$pdf->Ln(3);
$pdf->Cell(40,$SPACES,"Bank Name       :",0,0);
$pdf->Cell(65,$SPACES,$bankName['bankDesc'],0,1);
$pdf->Cell(40,$SPACES,"Account Number  :",0,0);
$pdf->Cell(65,$SPACES,$dispEmp['empAcctNo'],0,1);
$pdf->Ln(10);
...
$MRate = number_format($dispEmp['empMrate'],2);
$DRate = number_format($dispEmp['empDrate'],2);
$HRate = number_format($dispEmp['empHrate'],2);
if (!in_array(1,explode(',',$_SESSION['user_payCat'])))  {
	if ($dispEmp['empPayCat'] == 1) {
		$MRate = '--';
		$DRate = '--';
		$HRate = '--';
	}
}	
$pdf->Cell(65,$SPACES,$MRate,0,1);
$pdf->Cell(40,$SPACES,"Daily Rate      :",0,0);
$pdf->Cell(65,$SPACES,$DRate,0,1);
$pdf->Cell(40,$SPACES,"Hourly Rate     :",0,0);
$pdf->Cell(65,$SPACES,$HRate,0,1);
$pdf->Ln(5);
$pdf->Cell(5, 0, '', 0, 0);
$pdf->Cell(180, 0, '', 1, 1);
$pdf->Cell(5,3,"",0,0);
...
foreach ($arrAllowList as $allowListVal){
	...
	$pdf->Cell(25,$SPACES,$AllwAmt,0,1,'R');
}
#########################################################################
$pdf->Ln(5);
...
$pdf->Footer();
#########################################################################
$pdf->Output('EMPLOYEE_CONFIDENTIAL_INFORMATION.pdf','D');
?>
