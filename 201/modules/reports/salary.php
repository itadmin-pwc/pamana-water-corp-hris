...
<form name="frmTS" method="post" action="<? echo $_SERVER['PHP_SELF']; ?>">
  <table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
    <tr>
      ...
      <td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Salary Increase 
        Reports</td>
	</tr>
	<tr>
		<td class="parentGridDtl" >
          ...
          <tr>
            ...
            <td class="gridDtlVal"><? 					
								$arrRes = $inqTSObj->makeArr($inqTSObj->getReason(),'reasonCd','reasonDesc','');
								$inqTSObj->DropDownMenu($arrRes,'code',$code,$empSect_dis);
							?></td>
          ...
          <tr>
            ...
            <td class="gridDtlVal"><font class="byOrder">
              <?
					$inqTSObj->DropDownMenu(array('1'=>'POSTED','2'=>'UNPOSTED'),'ReportType',$orderBy,$orderBy_dis); 
			  ?>
            </font></td>
            <td class="gridDtlVal">&nbsp;</td>
          </tr>
          <tr>
            ...
            <td class="gridDtlLbl">:</td>
            <td width="10%" class="gridDtlVal"><input value="" type='text' onChange="valDateStartEnd(this.value,this.id,document.frmTS.txttoDate.value);" class='inputs' name='txtfrDate' id='txtfrDate' maxLength='10' readonly size="10"/>
            ...
            <td width="69%" class="gridDtlVal">&nbsp;</td>
          </tr>
          <tr>
...
<br>
			  <TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
				  <tr>
					<td>
						<CENTER>
                <input type="button" name="salary" id="salary" class="inputs" <? echo $searchTS4_dis; ?> value="Salary Increase" onClick="valSearchTS(this.id);">
              </CENTER>
					</td>
				  </tr>
			  </table> 
