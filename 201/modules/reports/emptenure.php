...
<br>
			  <TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
				  <tr>
					<td>
						<CENTER>
                <input type="button" name="salary" class="inputs" id="salary" <? echo $searchTS4_dis; ?> value=" Pdf " onClick="EmpTenure('Pdf');">
                <input type="button" name="salary2" class="inputs" id="salary2" <? echo $searchTS4_dis; ?> value="Chart" onClick="EmpTenure('chart');">
					  </CENTER>
					</td>
				  </tr>
			  </table> 
