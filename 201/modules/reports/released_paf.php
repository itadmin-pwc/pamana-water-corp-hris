...
<form name="frmTS" method="post" action="<? echo $_SERVER['PHP_SELF']; ?>">
  <table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
    <tr>
      ...
      <td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Released PAF</td>
	</tr>
	<tr>
		<td class="parentGridDtl" >
          ...
          <tr > 
            <td class="gridToolbar" colspan="7"> <input name="hide_option" type="hidden" id="hide_option" value="<? echo $option_menu; ?>"> 
              ...
              <input name='fileName' type='hidden' id='fileName' value="released_paf.php">            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="gridDtlLbl">:</td>
            <td width="17%" class="gridDtlVal"><input value="" type='text' onChange="valDateStartEnd(this.value,this.id,document.frmTS.txttoDate.value);" class='inputs' name='txtfrDate' id='txtfrDate' maxLength='10' readonly size="10"/>
            ...
            <td width="64%" class="gridDtlVal">&nbsp;</td>
          </tr>
          <tr>
...
<br>
			  <TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
				  <tr>
					<td>
						<CENTER>
                <input type="button" name="searchTS4" id="released_paf" class="inputs" <? echo $searchTS4_dis; ?> value="Print Released PAF Proof List in PDF Format" onClick="valSearchTS(this.id);">
                <input type="button" name="searchTS4" id="released_paf_excel" class="inputs" <? echo $searchTS4_dis;?> value="Print Released PAF Proof List in Excel Format" onClick="valSearchTS(this.id);">
              </CENTER>
					</td>
				  </tr>
			  </table> 
