...
<br>
			  <TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
				  <tr>
					<td>
						<CENTER>
                <input type="button" name="searchTS4" id="released_paf" <? echo $searchTS4_dis; ?> value="Print Released PAF Proof List in PDF Format" onClick="valSearchTS(this.id);">
                <input type="button" name="searchTS4" id="released_paf_excel" <? echo $searchTS4_dis;?> value="Print Released PAF Proof List in Excel Format" onClick="valSearchTS(this.id);">
              </CENTER>
					</td>
				  </tr>
			  </table> 
