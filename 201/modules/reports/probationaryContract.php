...
//			elseif($_GET['trans']==4){
//				echo "location.href = 'underTakingAgreement.php?trans=$trans&empno=$empnumber';";
//			}
//			elseif($_GET['trans']==5){
//				echo "location.href = 'trainingAgreement.php?trans=$trans&empno=$empnumber';";
//			}
		exit();
	break;	
}
			  ...
			  <TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
				  <tr>
					<td>
						...
						<CENTER>
                <input type="button" class="inputs" name="contractReports" id="contractReports" <? echo $searchTS4_dis; ?> value="Print" onClick="contractReport();">
				    </CENTER></td>
				  </tr>
			  </table> 
	</td>
