	...
	<BODY>
        <form name="frmTS" method="post" action="<? echo $_SERVER['../../../payroll/modules/special-reports/PHP_SELF']; ?>">
            ...
            <table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
           	 	<tr>
            		<td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Generate ER-2 Report</td>
            	</tr>
            		...
            		<td class="parentGridDtl" >
            			<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
                            ...
                            <tr> 
                            	...
                            	<td class="gridDtlVal"> 
                              		<? 	
									$inqTSObj->DropDownMenu(array('','Group 1'),'cmbgroup','',''); 				
									?>
                            	</td>
                            </tr>
            			...
            			<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
            				<tr>
            					<td>
                                    <CENTER>
                                    	<input type="button" name="btnemper2" class="inputs" id="btnemper2" <? echo $btnemper2_dis; ?> value="Generate ER-2 Report" onClick="return generatera1_validate('er2');">
                                    </CENTER>
            					</td>
            				</tr>
            			</table> 
