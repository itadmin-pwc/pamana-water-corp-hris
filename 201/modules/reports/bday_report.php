...
<script>
function bdaysReport() {
	var bdate = document.getElementById('cmbMonth').value;
	
	if(bdate!=0){
		document.frmTS.action = "bdayReport_pdf.php";
		document.frmTS.target = "_blank";
		document.frmTS.submit();
		document.frmTS.action = "bday_report.php";
...
<form name="frmTS" method="post" action="<? echo $_SERVER['PHP_SELF']; ?>">
  <table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
    <tr>
      ...
      <td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Birthday Report</td>
	</tr>
	<tr>
		<td class="parentGridDtl" >
          ...
          <tr>
            <td width="18%" class="gridDtlLbl">Month</td>
            <td width="1%" class="gridDtlLbl">:</td>
            <td width="158" colspan="3" class="gridDtlVal"><? 
			$arrMonth = array('0'=>'','01'=>'January','02'=>'February','03'=>'March','04'=>'April','05'=>'May','06'=>'June','07'=>'July','08'=>'August','09'=>'September','10'=>'October','11'=>'November','12'=>'December');
				$inqTSObj->DropDownMenu($arrMonth,'cmbMonth','','');	
			?>            </td>
            </tr>            
			  ...
			  <TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
				  <tr>
					<td>
						...
						<CENTER>
                <input type="button" name="bdayReport" class="inputs" id="bdayReport" <? echo $searchTS4_dis; ?> value="Print" onClick="bdaysReport();">
				    </CENTER></td>
				  </tr>
			  </table> 
	</td>
