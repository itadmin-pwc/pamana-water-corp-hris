...
function exportExcel () {
	...
	if(document.frmTS.txttoDate.value==''){
		...
		document.frmTS.action = "branch_minWage_excel.php";
		document.frmTS.target = "_blank";
		document.frmTS.submit();
		document.frmTS.action = "branch_minWage.php";
...
function printPdf () {
	...
	if(document.frmTS.txttoDate.value==''){
		...
		document.frmTS.action = "branch_minWage_pdf.php";
		document.frmTS.target = "_blank";
		document.frmTS.submit();
		document.frmTS.action = "branch_minWage.php";
		document.frmTS.target = "_self";
...
<form name="frmTS" method="post" action="<? echo $_SERVER['PHP_SELF']; ?>">
  <table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
    <tr>
      ...
      <td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Branch Listing of Updated Minimum Wage Report</td>
	</tr>
	<tr>
...
<br>
			  <TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
				  <tr>
					<td>
						<CENTER>
                <input type="button" name="salary2" id="salary2" <? echo $searchTS4_dis; ?> value="Print to PDF" onClick="printPdf(); valDateStartEnd(document.frmTS.txtfrDate.value,document.frmTS.txtfrDate.id,document.frmTS.txttoDate.value);">
                <input type="button" name="salary" id="salary" <? echo $searchTS4_dis; ?> value="Export to Excel" onClick="exportExcel(); valDateStartEnd(document.frmTS.txtfrDate.value,document.frmTS.txtfrDate.id,document.frmTS.txttoDate.value);">
					  </CENTER>
					</td>
				  </tr>
			  </table> 
