...
$reportPath = 'r1A_pdf.php?&compCode='.$empBrnCode.'&cmbgroup='.$cmbgroup.'&monthto='.$monthto.'&monthfr='.$monthfr.'"';
					...
					<td class="parentGridDtl">
						<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
						  	<td colspan="27" class="gridToolbar" align="">
								<input name="back" type="button" id="back" value="Back" onClick="location.href='r1A.php';">
              				</td>
