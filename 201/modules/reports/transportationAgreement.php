...
class PDF extends fpdf_multicelltag
{
	...
	function Content() {
		...
		$this->Ln(3);		
		//$this->Cell(13,5,"",0,0,"L");		
		$this->MultiCellTag(175,5,"	  1. <u>$empname</u> is an employee of Pamana Water Corporation with a position of <u>$empPos</u>.",0,"J",0,true);
		$this->Ln(3);		
		$this->MultiCellTag(175,5,"	  2. In the performance of $sex duties, $gender has to regularly travel from one branch of Pamana Water to another.",0,"J",0,true);
		$this->Ln(3);		
		...
		$this->Ln(3);		
		$this->MultiCellTag(175,5,"	  4. <u>$emplname</u> hereby manifest that the said fixed amount of transportation allowance is more than sufficient to cover the actual cost of the transportation that $gender incurs in connection with the business of Pamana Water.",0,"J",0,true);
		$this->Ln(3);		
		...
		$this->Ln(3);		
		$this->MultiCellTag(175,5,"	  6. The grant of transportation allowance can be revoked by Pamana Water at any time for any cause such as when the work of <u>$emplname</u> no longer requires regular travel or when Pamana Water decides to simply advance or require <u>$emplname</u> to seek reimbursement of $sex actual transportation expenses.",0,"J",0,true);
		$this->Ln(3);		
