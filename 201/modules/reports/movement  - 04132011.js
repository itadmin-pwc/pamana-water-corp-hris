// JavaScript Document
	...
	function COE() {
		...
		new Ajax.Request(
		  'movement_ajax.php?hide_empSect='+hide_empSect+'&hide_empDept='+hide_empDept+'&inputId=empSearch&empNo='+empNo+'&optionId='+optionId+'&fileName='+fileName+'&thisValue=COE&type='+Type,
		  {
			 asynchronous : true,     
			 onComplete   : function (req){
				eval(req.responseText);
