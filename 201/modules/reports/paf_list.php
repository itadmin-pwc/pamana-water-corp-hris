...
<HTML>
	...
	<BODY>
		<form name="frmTS" method="post" action="">
		  ...
		  <input type="hidden" name="pafType" id="pafType" value="<? echo $_GET['pafType']; ?>">
...
<SCRIPT>
	...
	pager("paf_list_ajax.php","TSCont",'load',0,0,'','','&empNo='+empNo+'&empName='+empName+'&empDiv='+empDiv+'&empDept='+empDept+'&empSect='+empSect+'&groupType='+groupType+'&orderBy='+orderBy+'&pafType='+pafType+'&from='+from+'&to='+to+'&type=<?=$_GET['type']?>','../../../images/');  
</SCRIPT>