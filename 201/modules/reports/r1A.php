	...
	<BODY>
        <form name="frmTS" method="post" action="<? echo $_SERVER['../../../payroll/modules/special-reports/PHP_SELF']; ?>">
            ...
            <table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
           	 	<tr>
            		<td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Generate R1A Report</td>
            	</tr>
            		...
            		<td class="parentGridDtl" >
            			...
            			<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
            				<tr>
            					<td>
                                    <CENTER>
                                    	<input type="button" name="btnempra1" class="inputs" id="btnempra1" <? echo $btnempra1_dis; ?> value="Generate R1A Report" onClick="return generatera1_validate('r1A');">
                                    </CENTER>
            					</td>
            				</tr>
            			</table> 
