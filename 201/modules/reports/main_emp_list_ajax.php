			...
			<TABLE border="0" width="100%" cellpadding="1" cellspacing="0" class="parentGrid">
			  ...
			  <td colspan="4" class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Employee 
				...
				<tr>
					...
					<td class="gridDtlVal" align="center"> <a href="#" onclick="location.href='<?=$fileName?>?hide_option=new_&empNo=<?=$empListVal['empNo']?>'"><img class="actionImg" src="../../../images/application_get.png" title="Select Employee"></a> 
					</td>
							</tr>
							<?
								}
