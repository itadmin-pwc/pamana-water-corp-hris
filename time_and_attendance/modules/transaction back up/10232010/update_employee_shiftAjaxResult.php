<?php
	...
	*/
	...
	{
		case 'getEmpInfo':
				$empInfo = $updateEmpShiftObj->getUserInfo($_SESSION['company_code'],$_GET['empNo'],'');
		...
		<td class="parentGridDtl" valign="top">
            ...
            <TABLE width="100%" cellpadding="0" cellspacing="1" border="0" class="" align="center">
            	<tr style="height:25px;">
                    ...
                    <td width="10%"class="gridDtlLbl" align="center" >DAY TYPE</td>		
                    <td width="10%" class="gridDtlLbl" align="center">IN</td>
                    <td width="10%" class="gridDtlLbl" align="center">LUNCH<br />OUT</td>
                    <td width="10%" class="gridDtlLbl" align="center">LUNCH<br />IN</td>
                    <td width="10%" class="gridDtlLbl" align="center">BRK <br />OUT</td>
                    <td width="10%" class="gridDtlLbl" align="center">BRK<br />IN</td>
                    <td width="10%" class="gridDtlLbl" align="center">OUT</td>
				...
				?>
                                   ...
                                   <tr>
                                        ...
                                        <td width="10%" align="center" class='gridDtlVal'><input type="text" class="inputs" readonly="readonly" name='txttsDate<?=$ctrDays.date("w", strtotime($arr_EmpTsInfo_val["tsDate"]))?>' id='txttsDate<?=$ctrDays.date("w", strtotime($arr_EmpTsInfo_val["tsDate"]))?>' value="<?=date("m/d/Y", strtotime($arr_EmpTsInfo_val["tsDate"]))?>" /></td>
                                         <td width="10%" align="left" class='gridDtlVal'><input type="text" class="inputs" readonly="readonly" value="<?=" ".strtoupper(date("l", strtotime($arr_EmpTsInfo_val["tsDate"])))?>" /></td>
                                         
                                        <td width="10%" align="center" class='gridDtlVal'><input type='text' class='inputs'  readonly="readonly" name='txtEtimeIn<?=$ctrDays.date("w", strtotime($arr_EmpTsInfo_val["tsDate"]))?>' id='txtEtimeIn<?=$ctrDays.date("w", strtotime($arr_EmpTsInfo_val["tsDate"]))?>'  style='width:50%; color:<?=$font_editedTs?>;' onKeyDown="javascript:return dFilter (event.keyCode, this, '##:##');" value='<?=$arr_EmpTsInfo_val["shftTimeIn"]?>'></td>
                                        <td width="10%" align="center" class='gridDtlVal'><input type='text' class='inputs' readonly="readonly" name='txtElunchOut<?=$ctrDays.date("w", strtotime($arr_EmpTsInfo_val["tsDate"]))?>' id='txtElunchOut<?=$ctrDays.date("w", strtotime($arr_EmpTsInfo_val["tsDate"]))?>'  style='width:50%;  color:<?=$font_editedTs?>;' onKeyDown="javascript:return dFilter (event.keyCode, this, '##:##');" value='<?=$arr_EmpTsInfo_val["shftLunchOut"]?>'></td>
                                        <td width="10%" align="center" class='gridDtlVal'><input type='text' class='inputs' readonly="readonly" name='txtElunchIn<?=$ctrDays.date("w", strtotime($arr_EmpTsInfo_val["tsDate"]))?>' id='txtElunchIn<?=$ctrDays.date("w", strtotime($arr_EmpTsInfo_val["tsDate"]))?>' style='width:50%; color:<?=$font_editedTs?>;' onKeyDown="javascript:return dFilter (event.keyCode, this, '##:##');" value='<?=$arr_EmpTsInfo_val["shftLunchIn"]?>'></td>
                                        <td width="10%" align="center" class='gridDtlVal'><input type='text' class='inputs' readonly="readonly" name='txtEbrkOut<?=$ctrDays.date("w", strtotime($arr_EmpTsInfo_val["tsDate"]))?>' id='txtEbrkOut<?=$ctrDays.date("w", strtotime($arr_EmpTsInfo_val["tsDate"]))?>' style='width:50%; color:<?=$font_editedTs?>;' onKeyDown="javascript:return dFilter (event.keyCode, this, '##:##');" value='<?=$arr_EmpTsInfo_val["shftBreakOut"]?>'></td>
                                        <td width="10%" align="center" class='gridDtlVal'><input type='text' class='inputs' readonly="readonly" name='txtEbrkIn<?=$ctrDays.date("w", strtotime($arr_EmpTsInfo_val["tsDate"]))?>' id='txtEbrkIn<?=$ctrDays.date("w", strtotime($arr_EmpTsInfo_val["tsDate"]))?>' style='width:50%; color:<?=$font_editedTs?>;' onKeyDown="javascript:return dFilter (event.keyCode, this, '##:##');" value='<?=$arr_EmpTsInfo_val["shftBreakIn"]?>'></td>
                                        <td width="10%" align="center" class='gridDtlVal'><input type='text' class='inputs' readonly="readonly" name='txtEtimeOut<?=$ctrDays.date("w", strtotime($arr_EmpTsInfo_val["tsDate"]))?>' id='txtEtimeOut<?=$ctrDays.date("w", strtotime($arr_EmpTsInfo_val["tsDate"]))?>' style='width:50%; color:<?=$font_editedTs?>;' onKeyDown="javascript:return dFilter (event.keyCode, this, '##:##');" value='<?=$arr_EmpTsInfo_val["shftTimeOut"]?>'></td>
