				...
				<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
                    ...
                    <tr class="gridToolbar" style="height:20px;">
                        ...
                        <td width="25%">
                            ...
                            ?>
                            <input name="back" type="button" id="back" value="Back" onClick="location.href='view_edit_employee_timesheet.php';">
                        </td>
                    </tr>
                                	...
                                	<td width="50%" >
                                    	...
                                    	<TABLE border="1" width="100%" cellpadding="1" cellspacing="1" style="border-collapse:collapse;">
                                        	...
                                        	<tr  class="gridToolbar" align="center" style="height:25px;">
                                                ...
                                                <td width="7%" class="fntTblHdr" style="font-size:11px;">App. Type</td>
                                                <td width="5%" class="fntTblHdr" style="font-size:11px;">Time<br />In</td>
                                                <td width="5%" class="fntTblHdr" style="font-size:11px;">Lunch<br />Out</td>
                                                <td width="5%" class="fntTblHdr" style="font-size:11px;">Lunch<br />In</td>
                                                <td width="5%" class="fntTblHdr" style="font-size:11px;">Brk.<br />Out</td>
                                     ...
                                     <div id="Panel1" style="height: 200px; width:1200px; overflow-y: scroll;">   
                                     	<TABLE border="1" width="100%"  cellpadding="1" cellspacing="1" style="border-collapse:collapse;">
                                        	<?php
												$arr_EmpTsInfo =  $emptimesheetObj->getTblData("tblTK_Timesheet", " and empNo='".$arr_empInfo["empNo"]."' and tsDate between '".date("m/d/Y", strtotime($arr_period_Info["pdFrmDate"]))."' and '".date("m/d/Y", strtotime($arr_period_Info["pdToDate"]))."'", " order by tsDate", "");
											...
											?>
                                                    <tr  class="gridToolbar" align="center" style="height:25px;">
                                                        <td width="6%" ><font color="<?=$f_color?>"> <?=date("m/d/Y", strtotime($arr_EmpTsInfo_val["tsDate"]))?></font></td>
                                                        <td width="7%" ><font style="font-family : Arial, Helvetica, sans-serif; font-size:10px; font-weight:bold" color="<?=$f_color?>"><?=$DayTypeDesc?></font></td>
                                                        ...
                                                        <td width="7%" align="left"><font style="font-family : Arial, Helvetica, sans-serif; font-size:10px; font-weight:bold" color="<?=$f_color?>"><?=$appTypeDesc["appTypeDesc"]?></font></td>
                                                        ...
                                                        {
                                                        ?>
                                                        	<a href="#"  onClick=""><img class="toolbarImg" src="../../../images/application_form_edit.png" title="View/Edit Shift Code Detail" onclick="maintShiftCode('Update','<?=date("m/d/Y", strtotime($arr_EmpTsInfo_val["tsDate"]))?>','<?=$arr_EmpTsInfo_val["empNo"]?>','<?=$pdSeries?>','employee_timesheet_pop.php','empTimeSheet',0,'','','txtSrch','cmbSrch')"></a>                                    
                                                        <?php
                                                        }
                                                        elseif($arr_EmpTsInfo_val["checkTag"]=='C') 
                                                        {
                                                        	$ediTedby = $emptimesheetObj->getUserHeaderInfo($_SESSION['employee_number'],$_SESSION['employee_id']); 
                                                       	 	$title =  "Edited By : ".$ediTedby["empLastName"].", ".$ediTedby["empFirstName"][0].".".$ediTedby["empMidName"][0]."."." on ".date("m/d/Y", strtotime($arr_EmpTsInfo_val["dateEdited"]));
                                                        ?>
                                                        	<a href="#"  onClick=""><img class="toolbarImg" src="../../../images/edit_prev_emp.png" title="<?=$title?>" onclick="maintShiftCode('Update_TsCorr','<?=date("m/d/Y", strtotime($arr_EmpTsInfo_val["tsDate"]))?>','<?=$arr_EmpTsInfo_val["empNo"]?>','<?=$pdSeries?>','employee_timesheet_pop.php','empTimeSheet',0,'','','txtSrch','cmbSrch')"></a>                                    
