...
switch($_GET["action"])
{
	case "NEWREFNO":
		...
		echo "document.frmOB.obreason.disabled=false; document.frmOB.rdnDeduct8.disabled=false; document.frmOB.obdestination.disabled=false; document.frmOB.txtobTimeIn.disabled=false; document.frmOB.txtobTimeOut.disabled=false; document.frmOB.btnSave.disabled=false;";
	...
	case "getEmpShiftCode":
		...
		if($shiftCodeDtl["shftTimeIn"]=="")
			echo "$('shiftSched').value='Set the Schedule first.';document.frmOB.rdnDeduct8.disabled=true; document.frmOB.obreason.disabled=true; document.frmOB.obdestination.disabled=true; document.frmOB.txtobTimeIn.disabled=true; document.frmOB.txtobTimeOut.disabled=true; document.frmOB.btnSave.disabled=true;";
		else
