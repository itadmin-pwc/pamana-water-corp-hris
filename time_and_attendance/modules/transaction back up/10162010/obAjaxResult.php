<?php
	...
	*/
	...
	$qryIntMaxRec.=			"ORDER BY OBApp.refNo, OBApp.obDate, empMast.empLastName, empMast.empFirstName";
	...
	$qryOBApp = "SELECT     TOP $intLimit OBApp.compCode, OBApp.refNo, OBApp.obDate,OBApp.empNo, empMast.empLastName, empMast.empFirstName,obReason, obActualTimeOut, obActualTimeIn, seqNo,obStat,obDestination,userApproved
							FROM  tblTK_OBApp OBApp INNER JOIN
							tblEmpMast empMast ON OBApp.empNo = empMast.empNo
							WHERE     (OBApp.compCode = '".$_SESSION["company_code"]."') 
							AND (empMast.compCode = '".$_SESSION["company_code"]."')
							AND seqNo not in 
									(Select TOP $intOffset OBApp.seqNo from tblTK_OBApp  OBApp
									WHERE (OBApp.compCode = '".$_SESSION["company_code"]."') "; 
									if($_GET['isSearch'] == 1){
										if($_GET['srchType'] == 0){
											$qryOBApp .= "AND obStat='A'";
		...
		$qryOBApp .=				"ORDER BY OBApp.refNo, OBApp.obDate)";
	...
	$qryOBApp.=			"ORDER BY OBApp.refNo, OBApp.obDate, empMast.empLastName, empMast.empFirstName;";
		...
		<td class="parentGridDtl" valign="top">
            ...
            <TABLE width="100%" cellpadding="0" cellspacing="1" border="0" class="" align="center">
				...
				<tr>
                    ...
                    <td width="10%" class="gridDtlLbl" align="center">OB SCHED.</td>
                ...
                <tr>
                    ...
                    <input type="hidden" name="schedTimeOut" id="schedTimeOut" value="" />
                   
                    <td><input type="text" readonly="readonly" class="inputs" name="shiftSched"  id="shiftSched" style="width:100%;" value="" /></td>
			...
			<TABLE width="100%" cellpadding="0" cellspacing="1" border="0" class="" align="center">
                ...
                <tr>
                    <td colspan="8" class="gridToolbar">
                        ...
                        <input tabindex="17" class="inputs" type="button" name="btnSrch" id="btnSrch" value="SEARCH" onClick="pager('obAjaxResult.php','obCont','Search',0,1,'txtSrch','cmbSrch','&refNo=<?=$_GET['refNo']?>','../../../images/')"> 
