<?
	...
	*/
	...
	if($brnCode_View ==""){
		...
		$qryIntMaxRec = "SELECT empTimeSheet.empNo, empMast.empLastName, empMast.empFirstName, empMast.empMidName
						 FROM tblTK_Timesheet empTimeSheet 
						 INNER JOIN tblEmpMast empMast ON empTimeSheet.empNo = empMast.empNo
						 WHERE (empTimeSheet.compcode = '".$_SESSION["company_code"]."') AND (empMast.compCode = '".$_SESSION["company_code"]."')
	...
	$qryIntMaxRec.= " GROUP BY empTimeSheet.empNo, empMast.empLastName, empMast.empFirstName, empMast.empMidName  
	...
	$qryEmpList = "SELECT  empTimeSheet.empNo, empMast.empLastName, empMast.empFirstName, empMast.empMidName
				   FROM tblTK_Timesheet empTimeSheet 
				   INNER JOIN tblEmpMast empMast ON empTimeSheet.empNo = empMast.empNo
				   WHERE (empTimeSheet.compcode = '".$_SESSION["company_code"]."') 
	...
	$qryEmpList .=" GROUP BY empTimeSheet.empNo,  empMast.empLastName, empMast.empFirstName, empMast.empMidName 
					ORDER BY empMast.empLastName, empMast.empFirstName, empMast.empMidName
			...
			<td class="parentGridDtl" valign="top">
				<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
					<td colspan="6" class="gridToolbar">
						...
						<INPUT class="inputs" type="button" name="btnSrch" id="btnSrch" value="SEARCH" onClick="pager('employee_list_timesheet_manual_entry_listAjaxResult.php','empMastCont','Search',0,1,'txtSrch','cmbSrch','&url=<?=$url?>&brnCd='+document.getElementById('brnCd').value,'','../../../images/')">
					</td>
                    ...
                    <tr>
						...
						<?
							...
							{
						?>
                        		<td width="58%" class="gridDtlLbl" align="center">NAME</td>
               			<?
							}
							else
							{
						?>
                    			<td width="24%" class="gridDtlLbl" align="center">&nbsp;</td>
                        <?
                        	}
						?>
					...
					?>
                            <tr  bgcolor="<?php echo $bgcolor; ?>" <?php echo $on_mouse; ?>>
                                ...
                                <td class="gridDtlVal" align="center">
                                	<a href="#" onClick="location.href='employee_timesheet_manual_entry.php?empNo=<?=$empListVal['empNo']?>&url=<?=($url!=""?$url:"view")?>'"><img class="toolbarImg" src="../../../images/application_form_edit.png" title="View/Edit Employee Time Sheet"></a>
								</td>
					...
					?>
                        <tr>
                            <td colspan="6" align="center">
                                <FONT class="zeroMsg">GENERATE EMPLOYEE SCHEDULE FIRST!!!!</font>
                            </td>
                        </tr>
					<?
                    }
                    ...
                    <tr>
						<td colspan="6" align="center" class="childGridFooter">
                        	<? $pager->_viewPagerButton("employee_list_timesheet_manual_entry_listAjaxResult.php",'empMastCont',$intOffset,$_GET['isSearch'],'txtSrch','cmbSrch','&brnCd='.$_GET["brnCd"].'&url='.$url,'');?>
						</td>
					</tr>
				</TABLE>
