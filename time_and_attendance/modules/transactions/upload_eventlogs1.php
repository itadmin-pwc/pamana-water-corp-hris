...
//			$sqlDelete = "Delete from tblTK_EventLogs where cStoreNum='{$_GET['brnCode']}' AND (EDATE>='". $frDate."' AND EDATE<='".$toDate."') and len(ETAG)<8";
			$BioLength = ($_GET['brnCode'] == 1)? 4:5;
			$sqlDelete = "Delete from tblTK_EventLogs where (EDATE>='". $frDate."' AND EDATE<='".$toDate."') and len(ETAG)>=$BioLength";
