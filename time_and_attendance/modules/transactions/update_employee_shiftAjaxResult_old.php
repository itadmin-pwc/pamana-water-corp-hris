            ...
            <TABLE width="100%" cellpadding="0" cellspacing="1" border="0" class="" align="center">
				...
				?>
                                   ...
                                   <tr>
                                        ...
                                        <td width="9%" align="center" class='gridDtlVal'><input type="text" class="inputs" readonly="readonly" name='txttsDate<?=$ctrDays.date("w", strtotime($arr_EmpTsInfo_val["tsDate"]))?>' id='txttsDate<?=$ctrDays.date("w", strtotime($arr_EmpTsInfo_val["tsDate"]))?>' value="<?=date("m/d/Y", strtotime($arr_EmpTsInfo_val["tsDate"]))?>" /></td>
