...
switch($_GET["action"])
{
	...
	case "saveObSched":
		...
		$getPdNum_NxtCutOff = $obObj->getTblData("tblPayPeriod", " and payGrp='".$_GET["empPayGrp"]."' and payCat='".$_GET["empPayCat"]."'  and  pdTSStat='O' ", "", "sqlAssoc");
...
//						echo "saveMessage('".$insRecObTran."q"."')";
							echo "alert('$insRecObTran');";
							echo "$('obDate').value='';";
							echo "$('schedTimeIn').value='';";
							echo "$('schedTimeOut').value='';";
							echo "$('obdestination').value='0';";
							echo "$('rdnDeduct8').value='0';";
							echo "$('obreason').value='';";
							echo "$('txtobTimeIn').value='';";
							echo "$('txtobTimeOut').value='';";
				...
				{
					$insRecObTran = $obObj->tran_Ob($_GET,($_GET["Edited"]!=""?"Update":"Add"));
//					echo "saveMessage('".$insRecObTran."q1"."')";
							echo "alert('$insRecObTran');";
							echo "$('obDate').value='';";
							echo "$('schedTimeIn').value='';";
							echo "$('schedTimeOut').value='';";
		...
		else
		{
			...
			if($getPdNum_Open2["pdSeries"]!="")
			{
				...
				else
				{
					...
					{
						$insRecObTran = $obObj->tran_Ob($_GET,($_GET["Edited"]!=""?"Update":"Add"));
//						echo "saveMessage('".$insRecObTran."q3"."')";
							echo "alert('$insRecObTran');";
							echo "$('obDate').value='';";
							echo "$('schedTimeIn').value='';";
							echo "$('schedTimeOut').value='';";
