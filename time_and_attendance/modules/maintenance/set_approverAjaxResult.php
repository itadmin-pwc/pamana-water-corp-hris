			...
			<TABLE cellpadding="1" cellspacing="1" border="0" class="hdrTable" width="100%">
				...
				<td class="hdrInputsLvl" width="127" >
					...
					<td class="gridDtlVal" colspan="4"><?
						$reasons=$AppObj->getTblData("tblTK_Reasons "," and stat='A' and ovApp='Y'"," order by reason","sqlArres");
						$arrReasons = $AppObj->makeArr($reasons,'reason_id','reason','');
						$AppObj->DropDownMenu($arrReasons,'cmbReasons',"","class='inputs'");
					?></td>
