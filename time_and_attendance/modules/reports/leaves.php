...
<form name="frmTS" method="post" action="<? echo $_SERVER['PHP_SELF']; ?>">
  <table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
    <tr>
      ...
      <td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Leave Applications</td>
	</tr>
	<tr>
		<td class="parentGridDtl" >
          ...
          <tr>
			...
			$arrBranchRes = $inqTSObj->getArrRes($inqTSObj->execQry($sqlBranch));
			$arrBranch = $inqTSObj->makeArr($arrBranchRes,'brnCode','brnDesc','');
...
<br>
			  <TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
				  <tr>
					<td>
						<CENTER>
                <input type="button" name="salary" id="salary" <? echo $searchTS4_dis; ?> class="inputs" value="Leave Applications" onClick="Leaves();">
					  </CENTER>
					</td>
				  </tr>
			  </table> 
