...
/*			
			...
			if($val['dayType']=="03" || $val['dayType']=="05" || $val['dayType']=="07" || $val['dayType']=="08"){
			...
			$corrlogs="";
			$corrlogs=$this->checkcorrlogs($val['empNo'],$val['tsDate']);
		
			//if($corrlogs!=''){$this->SetFont('Courier', 'BI', '8');}else{$this->SetFont('Courier', '', '8');}
			...
			//if($corrlogs!=''){$this->SetFont('Courier', 'BI', '10');}else{$this->SetFont('Courier', '', '10');}
			$this->SetFont('Courier', '', '10');
			...
			if($corrlogs!=''){$this->SetFont('Courier', 'B', '10');}else{$this->SetFont('Courier', '', '10');}
