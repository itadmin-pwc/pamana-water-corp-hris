...
<form name="frmTS" method="post" action="<? echo $_SERVER['PHP_SELF']; ?>">
  <table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
    <tr>
      ...
      <td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Over Break Reports</td>
	</tr>
	<tr>
		<td class="parentGridDtl" >
			  <TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
          <tr > 
            <td class="gridToolbar" colspan="8"> <input  name="hide_option" type="hidden" id="hide_option" value="<? echo $option_menu; ?>"> 
          ...
          <tr>
			...
			$arrBranch = $inqTSObj->getArrRes($inqTSObj->execQry($sqlBranch));
								...
								$inqTSObj->DropDownMenu($arrBranch,'branch',$empDiv,$cmbtable_dis .' onChange="CheckGroupOverBreak(this.value)"');
							?>            </td>
            </tr>
          <tr>
            ...
            <td colspan="3" class="gridDtlVal"><span class="gridDtlVal style5">
              <? $inqTSObj->DropDownMenu(
				array('','1'=>'Group 1'),'cmbGroup',0,'class="inputs" style="width:100px;" disabled onChange="CheckGroupOverBreak(document.frmTS.branch.value)"'); ?>
            </span></td>
            </tr>
          <tr>
          ...
          <tr>
            ...
            <td colspan="3" class="gridDtlVal"><span class="gridDtlVal style5">
              <? $inqTSObj->DropDownMenu(
				...
				,'cmbBreak','',$cmbBreak_dis .' class="inputs" style="width:150px;"'); ?>
            </span></td>
          </tr>
          </table>
<br>
			  <TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
				  <tr>
					<td>
						<CENTER>
                <input type="button" name="salary" id="salary" class="inputs" <? echo $searchTS4_dis; ?> value="Print Over Break" onClick="OverBreak();">
					  </CENTER>
					</td>
				  </tr>
			  </table> 
