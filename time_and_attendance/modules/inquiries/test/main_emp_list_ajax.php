					...
					<td class="gridDtlVal" align="center"> <a href="#" onclick="location.href='<?=$fileName?>?hide_option=new_&empNo=<?=$empListVal['empNo']?><?php echo $search; ?>'"><img class="actionImg" src="../../../images/application_get.png" title="Select Employee"></a> 
							...
							<tr>
								<td colspan="4" align="center" class="childGridFooter">
									<? $pager->_viewPagerButton("main_emp_list_ajax.php","empMastCont",$intOffset,$_GET['isSearch'],'txtSrch','cmbSrch','&empNo='.$empNo."&fileName=".$fileName."&inputId=".$inputId."&empName=".$empName."&empDiv=".$empDiv."&empDept=".$empDept."&empSect=".$empSect."&shiftCode=".$shiftCode."&empBrnCode=".$empBrnCode);?>
								</td>
							</tr>
						</TABLE>
					</td>
