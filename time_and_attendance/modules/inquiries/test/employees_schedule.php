...
/*
	...
	Function		:	Employees Schedule Report
*/
...
<HTML>
	...
	<BODY>
        <form name="frmTS" method="post" action="<? echo $_SERVER['../../../time_and_attendance/modules/inquiries/PHP_SELF']; ?>">
             <table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
           	 	<tr>
            		<td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Employees Schedule Report</td>
            	</tr>
            			...
            			<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
            				<tr > 
            					<td class="gridToolbar" colspan="6"> 
            						...
            						<input name='fileName' type='hidden' id='fileName' value="employees_schedule.php">                                </td>
            				</tr>
                           ...
                           <tr> 
            				...
            				<tr> 
                                ...
                                <td class="gridDtlVal"> 
                                    <? 					
                                        $arrShifts = $inqTSObj->makeArr($inqTSObj->getListShift(),'shiftCode','shiftDesc','All');
                                        $inqTSObj->DropDownMenu($arrShifts,'shiftcode',$shiftcode,$shiftcode_dis);
                                     ?>
                                </td>
                            </tr>
