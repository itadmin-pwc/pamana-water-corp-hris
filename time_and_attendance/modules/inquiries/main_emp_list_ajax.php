...
?>
	...
	<div class="niftyCorner">
    	<TABLE border="0" width="100%" cellpadding="1" cellspacing="0" class="parentGrid">
            <tr>
            	<td colspan="4" class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Employee Master List
            	...
            	<td class="parentGridDtl">
            		<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
            			<td colspan="4" class="gridToolbar"> 
            				<a href="#" onclick="location.href='view_edit_employee.php?transType=add'" class="anchor" ></a>
            			</td>
                        ...
                        ?>
                                <tr bgcolor="<?php echo $bgcolor; ?>" <?php echo $on_mouse; ?>>
                                    <td class="gridDtlVal"><?=$i?></td>
                                        ...
                                        <td class="gridDtlVal" align="center"> <a href="#" onclick="location.href='<?=$fileName?>?shiftCode=<?=$shiftCode?>&hide_option=new_&empNo=<?=$empListVal['empNo']?><?php echo $search; ?>'"><img class="actionImg" src="../../../images/application_get.png" title="Select Employee"></a> 
                                    </td>
                                </tr>
                		<?
                    		}
                    ...
                    <tr>
                        <td colspan="4" align="center" class="childGridFooter">
                            <? $pager->_viewPagerButton("main_emp_list_ajax.php","empMastCont",$intOffset,$_GET['isSearch'],'txtSrch','cmbSrch','&empNo='.$empNo."&fileName=".$fileName."&inputId=".$inputId."&empName=".$empName."&empDiv=".$empDiv."&empDept=".$empDept."&empSect=".$empSect."&empBrnCode=".$empBrnCode);?>
                        </td>
                    </tr>
    			</TABLE>
    		</td>
