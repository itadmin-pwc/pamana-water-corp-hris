...
<HTML>
	...
	<BODY>
        ...
        <input type="hidden" name="vioCode" id="vioCode" value="0">
       <table cellpadding="0" cellspacing="1" class="parentGrid" width="100%">
           	 	<tr>
            		<td class="parentGridHdr"> &nbsp;<img src="../../../images/grid.png">&nbsp;Employees Timesheet Report</td>
            	</tr>
            		...
            		<td class="parentGridDtl" >
            			<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid" >
            				<tr > 
            					<td class="gridToolbar" colspan="6"> 
            						...
            						<input name='fileName' type='hidden' id='fileName' value="employees_timesheet.php">                                </td>
            				</tr>
                           ...
                           <tr> 
            				...
            				<tr> 
                                <td class="gridDtlLbl" width="20%">Pay Group </td>
                                <td class="gridDtlLbl" width="1%">:</td>
                                <td class="gridDtlVal"> 
                                    <? 					
                                        $inqTSObj->DropDownMenu(array('1'=>'GROUP 1','2'=>'GROUP 2'),'payGrp',$payGrp,$payGrp_dis); 
                                     ?>
                                </td>
                            </tr>
            			...
            			<TABLE border="0" width="100%" cellpadding="1" cellspacing="1" class="childGrid">
            				<tr>
            					<td>
                                    <CENTER>
                                    	<input type="button" name="empTimesheet" class="inputs" id="empTimesheet" <? echo $btnpayrolltype_dis; ?> value="Generate Timesheet Report" onClick="valSearchTS(this.id);">
                                    </CENTER>
            					</td>
            				</tr>
            			</table> 
