...
$userLogInInfo = $modAccRghrsObj->getUserLogInInfo($_GET['compCode'],$_GET['empNo']);
			...
			<TABLE border="0" width="100%" cellpadding="1" cellspacing="0" class="parentGrid">
				...
				<tr>
					...
					?>
                            	...
                            	<INPUT type="checkbox" id="childModule<?=$j?>" name="childModule" value="<?=$childModuleVal['moduleId']?>"
										<?
											if(isset($_GET['transType']) == 'edit'){
												$getPagesPayRoll = $modAccRghrsObj->getPagesPayroll($userLogInInfo['pagesTNA']);
						...
						<INPUT class="inputs" type="button" value="Unckeck All" onClick="return unCheckAll(<?=$i?>,<?=$j?>,<?=$a?>);">
						<br>
					<?
						$i++;
						}
