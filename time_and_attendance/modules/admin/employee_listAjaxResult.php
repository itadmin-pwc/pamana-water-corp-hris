                        	...
                        	<table border="0" width="70%">
                            	<tr>
                                    ...
                                    ?>
                                    	...
                                    	<td width="30%" align="center"><a href="#" onclick="editUserBranch('Edit','<?php echo $empListVal['empNo']; ?>','<?=$empListVal['compCode']?>')"><img class="toolbarImg" src="../../../images/application_form_edit.png" title="Edit User Branch"></a></td>
                                    <?php 
                                        }else{ 
                                    ?>
                                        <td width="30%"></td>
