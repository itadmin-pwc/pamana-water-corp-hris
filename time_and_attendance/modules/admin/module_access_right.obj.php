...
class moduleAccessRightsObj extends commonObj {
	...
	function getParentModule(){
	    ...
	    $qryParentModule="select moduleName from tblTmeInAttendanceMenu 
	      				  WHERE moduleStat = 'A' 
	...
	function getChildModule($parentName){
		...
		$qryChildModule = "SELECT moduleId,label FROM tblTmeInAttendanceMenu
							WHERE moduleStat = 'A'
	...
	{
		$qryUserBranch = "Select * from tblTK_UserBranch where compCode='".$_SESSION["company_code"]."' and empNo='".$empNo."'";
