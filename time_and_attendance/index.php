	   ...
	   Ext.BLANK_IMAGE_URL = '../js/extjs/resources/images/default/s.gif';
		...
		var menuTreePanel = new Ext.tree.TreePanel({
	        ...
	        loader: new Ext.tree.TreeLoader({
	            dataUrl:'menu/timeAndAttendance_menu.php'
	        }),
			...
			<table border="0" cellpadding="0" cellspacing="1"  align="left" width="100%" style="background-color: white;">
				<tr>
					<td width="175" rowspan="4">
						<?
							if($moduleName == 'TIME AND ATTENDANCE')
							{
								echo '<img src="../images/pg-time-attendance-logo.jpg" width="178" height="77" class="pgLogo">	';					
							}
						?>					</td>
			  </tr>
				<tr>
